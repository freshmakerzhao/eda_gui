// This module implements the XsciLexerCSS class.
 


#include "Xsci/xscilexercss.h"
...
// The ctor.
XsciLexerCSS::XsciLexerCSS(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerCSS::~XsciLexerCSS()
{
}


// Returns the language name.
const char *XsciLexerCSS::language() const
{
    return "CSS";
}
...
const char *XsciLexerCSS::lexer() const
{
    return "css";
}
...
const char *XsciLexerCSS::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
const char *XsciLexerCSS::blockEnd(int *style) const
{
    if (style)
        *style = Operator;
...
const char *XsciLexerCSS::wordCharacters() const
{
...
QColor XsciLexerCSS::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
QFont XsciLexerCSS::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerCSS::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerCSS::description(int style) const
{
    switch (style)
    {
    case Default:
...
void XsciLexerCSS::refreshProperties()
{
    setCommentProp();
    setCompactProp();
    setHSSProp();
...
bool XsciLexerCSS::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool XsciLexerCSS::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool XsciLexerCSS::foldComments() const
{
...
void XsciLexerCSS::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerCSS::setCommentProp()
{
...
bool XsciLexerCSS::foldCompact() const
{
    return fold_compact;
}
...
void XsciLexerCSS::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerCSS::setCompactProp()
{
...
void XsciLexerCSS::setHSSLanguage(bool enabled)
{
...
void XsciLexerCSS::setLessLanguage(bool enabled)
{
...
void XsciLexerCSS::setSCSSLanguage(bool enabled)
{
