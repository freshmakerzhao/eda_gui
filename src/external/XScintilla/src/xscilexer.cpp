// This module implements the XsciLexer class.
...
void XsciLexer::setEditor(XsciScintilla *editor)
{
...
const char *XsciLexer::lexer() const
{
    return 0;
}
...
int XsciLexer::lexerId() const
{
    return XsciScintillaBase::SCLEX_CONTAINER;
}


// Return the number of style bits needed by the lexer.
int XsciLexer::styleBitsNeeded() const
{
    return 8;
}
...
void XsciLexer::setStyleDefaults() const
{
    if (!style_map->style_data_set)
    {
        for (int i = 0; i <= XsciScintillaBase::STYLE_MAX; ++i)
...
XsciLexer::StyleData &XsciLexer::styleData(int style) const
{
...
void XsciLexer::setAPIs(XsciAbstractAPIs *apis)
{
    apiSet = apis;
}
...
XsciAbstractAPIs *XsciLexer::apis() const
{
    return apiSet;
}
...
// auto-completion.
const char *XsciLexer::autoCompletionFillups() const
{
    return "(";
}
...
int XsciLexer::indentationGuideView() const
{
    return XsciScintillaBase::SC_IV_LOOKBOTH;
}


// Default implementation to return the list of character sequences that can
// separate auto-completion words.
QStringList XsciLexer::autoCompletionWordSeparators() const
{
    return QStringList();
}
...
// block.
const char *XsciLexer::blockStartKeyword(int *) const
{
    return 0;
}
...
// block.
const char *XsciLexer::blockStart(int *) const
{
    return 0;
}
...
// block.
const char *XsciLexer::blockEnd(int *) const
{
    return 0;
}
...
int XsciLexer::braceStyle() const
{
    return -1;
}
...
// auto-indenting.
int XsciLexer::blockLookback() const
{
    return 20;
}
...
bool XsciLexer::caseSensitive() const
{
    return true;
}
...
const char *XsciLexer::wordCharacters() const
{
    return 0;
}
...
int XsciLexer::defaultStyle() const
{
    return 0;
}
...
QColor XsciLexer::color(int style) const
{
...
QColor XsciLexer::paper(int style) const
{
...
QFont XsciLexer::font(int style) const
{
...
bool XsciLexer::eolFill(int style) const
{
...
const char *XsciLexer::keywords(int) const
{
    return 0;
}
...
bool XsciLexer::defaultEolFill(int) const
{
    return false;
}
...
QFont XsciLexer::defaultFont(int) const
{
    return defaultFont();
}
...
QFont XsciLexer::defaultFont() const
{
    return defFont;
}
...
void XsciLexer::setDefaultFont(const QFont &f)
{
    defFont = f;
}
...
QColor XsciLexer::defaultColor(int) const
{
    return defaultColor();
}
...
QColor XsciLexer::defaultColor() const
{
    return defColor;
}
...
void XsciLexer::setDefaultColor(const QColor &c)
{
    defColor = c;
}
...
QColor XsciLexer::defaultPaper(int) const
{
    return defaultPaper();
}
...
QColor XsciLexer::defaultPaper() const
{
    return defPaper;
}
...
void XsciLexer::setDefaultPaper(const QColor &c)
{
    defPaper = c;
    ...
    setPaper(c, XsciScintillaBase::STYLE_DEFAULT);
}


// Read properties from the settings.
bool XsciLexer::readProperties(QSettings &,const QString &)
{
    return true;
}
...
void XsciLexer::refreshProperties()
{
}


// Write properties to the settings.
bool XsciLexer::writeProperties(QSettings &,const QString &) const
{
    return true;
}
...
bool XsciLexer::readSettings(QSettings &qs,const char *prefix)
{
...
bool XsciLexer::writeSettings(QSettings &qs,const char *prefix) const
{
    bool rc = true;
    QString key, fmt("%1");
    int num;
...
void XsciLexer::setAutoIndentStyle(int autoindentstyle)
{
...
void XsciLexer::setColor(const QColor &c, int style)
{
    if (style >= 0)
    {
...
void XsciLexer::setEolFill(bool eolfill, int style)
{
    if (style >= 0)
    {
...
void XsciLexer::setFont(const QFont &f, int style)
{
    if (style >= 0)
    {
...
void XsciLexer::setPaper(const QColor &c, int style)
{
    if (style >= 0)
    {
    ...
    else
    {
        ...
        emit paperChanged(c, XsciScintillaBase::STYLE_DEFAULT);
    }
}
