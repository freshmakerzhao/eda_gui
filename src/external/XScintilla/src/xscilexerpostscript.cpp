// This module implements the XsciLexerPostScript class.
 


#include "Xsci/xscilexerpostscript.h"
...
// The ctor.
XsciLexerPostScript::XsciLexerPostScript(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerPostScript::~XsciLexerPostScript()
{
}


// Returns the language name.
const char *XsciLexerPostScript::language() const
{
    return "PostScript";
}
...
const char *XsciLexerPostScript::lexer() const
{
    return "ps";
}
...
int XsciLexerPostScript::braceStyle() const
{
...
QColor XsciLexerPostScript::defaultColor(int style) const
{
    switch (style)
    {
    case Comment:
...
QFont XsciLexerPostScript::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerPostScript::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerPostScript::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerPostScript::defaultPaper(int style) const
{
...
void XsciLexerPostScript::refreshProperties()
{
    setTokenizeProp();
    setLevelProp();
    setCompactProp();
...
bool XsciLexerPostScript::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool XsciLexerPostScript::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool XsciLexerPostScript::tokenize() const
{
    return ps_tokenize;
}
...
void XsciLexerPostScript::setTokenize(bool tokenize)
{
...
void XsciLexerPostScript::setTokenizeProp()
{
...
int XsciLexerPostScript::level() const
{
    return ps_level;
}
...
void XsciLexerPostScript::setLevel(int level)
{
    ps_level = level;
...
void XsciLexerPostScript::setLevelProp()
{
...
bool XsciLexerPostScript::foldCompact() const
{
    return fold_compact;
}
...
void XsciLexerPostScript::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerPostScript::setCompactProp()
{
...
bool XsciLexerPostScript::foldAtElse() const
{
    return fold_atelse;
}
...
void XsciLexerPostScript::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void XsciLexerPostScript::setAtElseProp()
{
