// This module implements the XsciLexerCPP class.
...
// The ctor.
XsciLexerCPP::XsciLexerCPP(QObject *parent, bool caseInsensitiveKeywords)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerCPP::~XsciLexerCPP()
{
}


// Returns the language name.
const char *XsciLexerCPP::language() const
{
    return "C++";
}
...
const char *XsciLexerCPP::lexer() const
{
...
// words.
QStringList XsciLexerCPP::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *XsciLexerCPP::blockStartKeyword(int *style) const
{
    if (style)
        *style = Keyword;
...
const char *XsciLexerCPP::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
const char *XsciLexerCPP::blockEnd(int *style) const
{
    if (style)
        *style = Operator;
...
int XsciLexerCPP::braceStyle() const
{
    return Operator;
}
...
const char *XsciLexerCPP::wordCharacters() const
{
...
QColor XsciLexerCPP::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerCPP::defaultEolFill(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
QFont XsciLexerCPP::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerCPP::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerCPP::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerCPP::defaultPaper(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
void XsciLexerCPP::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool XsciLexerCPP::readProperties(QSettings &qs,const QString &prefix)
{
...
bool XsciLexerCPP::writeProperties(QSettings &qs,const QString &prefix) const
{
...
void XsciLexerCPP::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void XsciLexerCPP::setAtElseProp()
{
...
void XsciLexerCPP::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerCPP::setCommentProp()
{
...
void XsciLexerCPP::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerCPP::setCompactProp()
{
...
void XsciLexerCPP::setFoldPreprocessor(bool fold)
{
    fold_preproc = fold;
...
void XsciLexerCPP::setPreprocProp()
{
...
void XsciLexerCPP::setStylePreprocessor(bool style)
{
    style_preproc = style;
...
void XsciLexerCPP::setStylePreprocProp()
{
...
void XsciLexerCPP::setDollarsAllowed(bool allowed)
{
    dollars = allowed;
...
void XsciLexerCPP::setDollarsProp()
{
...
void XsciLexerCPP::setHighlightTripleQuotedStrings(bool enabled)
{
...
void XsciLexerCPP::setHighlightTripleProp()
{
...
void XsciLexerCPP::setHighlightHashQuotedStrings(bool enabled)
{
...
void XsciLexerCPP::setHighlightHashProp()
{
...
void XsciLexerCPP::setHighlightBackQuotedStrings(bool enabled)
{
...
void XsciLexerCPP::setHighlightBackProp()
{
...
void XsciLexerCPP::setHighlightEscapeSequences(bool enabled)
{
...
void XsciLexerCPP::setHighlightEscapeProp()
{
...
void XsciLexerCPP::setVerbatimStringEscapeSequencesAllowed(bool allowed)
{
    vs_escape = allowed;
...
void XsciLexerCPP::setVerbatimStringEscapeProp()
{
