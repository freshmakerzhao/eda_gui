// This module implements the XsciLexerVHDL class.
 


#include "Xsci/xscilexervhdl.h"
...
// The ctor.
XsciLexerVHDL::XsciLexerVHDL(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerVHDL::~XsciLexerVHDL()
{
}


// Returns the language name.
const char *XsciLexerVHDL::language() const
{
    return "VHDL";
}
...
const char *XsciLexerVHDL::lexer() const
{
    return "vhdl";
}
...
int XsciLexerVHDL::braceStyle() const
{
    return Attribute;
}
...
QColor XsciLexerVHDL::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerVHDL::defaultEolFill(int style) const
{
...
QFont XsciLexerVHDL::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerVHDL::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerVHDL::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerVHDL::defaultPaper(int style) const
{
    if (style == UnclosedString)
...
void XsciLexerVHDL::refreshProperties()
{
    setCommentProp();
    setCompactProp();
    setAtElseProp();
...
bool XsciLexerVHDL::readProperties(QSettings &qs,const QString &prefix)
{
...
bool XsciLexerVHDL::writeProperties(QSettings &qs,const QString &prefix) const
{
...
bool XsciLexerVHDL::foldComments() const
{
...
void XsciLexerVHDL::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerVHDL::setCommentProp()
{
...
bool XsciLexerVHDL::foldCompact() const
{
    return fold_compact;
}
...
void XsciLexerVHDL::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerVHDL::setCompactProp()
{
...
bool XsciLexerVHDL::foldAtElse() const
{
    return fold_atelse;
}
...
void XsciLexerVHDL::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void XsciLexerVHDL::setAtElseProp()
{
...
bool XsciLexerVHDL::foldAtBegin() const
{
    return fold_atbegin;
}
...
void XsciLexerVHDL::setFoldAtBegin(bool fold)
{
    fold_atbegin = fold;
...
void XsciLexerVHDL::setAtBeginProp()
{
...
bool XsciLexerVHDL::foldAtParenthesis() const
{
...
void XsciLexerVHDL::setFoldAtParenthesis(bool fold)
{
    fold_atparenth = fold;
...
void XsciLexerVHDL::setAtParenthProp()
{
