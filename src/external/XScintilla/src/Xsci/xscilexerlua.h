// This defines the interface to the XsciLexerLua class.
 


#ifndef XSCILEXERLUA_H
#define XSCILEXERLUA_H
...
//! \brief The XsciLexerLua class encapsulates the Scintilla Lua
//! lexer.
class XSCINTILLA_EXPORT XsciLexerLua : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerLua with parent \a parent.  \a parent is typically
    //! the XsciScintilla instance.
    XsciLexerLua(QObject *parent = 0);

    //! Destroys the XsciLexerLua instance.
    virtual ~XsciLexerLua();
...
private:
    ...
    XsciLexerLua(const XsciLexerLua &);
    XsciLexerLua &operator=(const XsciLexerLua &);
};
