// This module defines interface to the XsciStyle class.
...
//! \brief The XsciStyle class encapsulates all the attributes of a style.
//!
...
class XSCINTILLA_EXPORT XsciStyle
{
public:
    ...
    //! Constructs a XsciStyle instance for style number \a style.  If \a style
    ...
    //!
    //! \sa style()
    XsciStyle(int style, const QString &description, const QColor &color,
