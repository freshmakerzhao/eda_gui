// This defines the interface to the XsciLexerCoffeeScript class.
 


#ifndef XSCILEXERCOFFEESCRIPT_H
#define XSCILEXERCOFFEESCRIPT_H
...
//! \brief The XsciLexerCoffeeScript class encapsulates the Scintilla
//! CoffeeScript lexer.
class XSCINTILLA_EXPORT XsciLexerCoffeeScript : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerCoffeeScript with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
    XsciLexerCoffeeScript(QObject *parent = 0);

    //! Destroys the XsciLexerCoffeeScript instance.
    virtual ~XsciLexerCoffeeScript();
...
private:
    ...
    XsciLexerCoffeeScript(const XsciLexerCoffeeScript &);
    XsciLexerCoffeeScript &operator=(const XsciLexerCoffeeScript &);
};
