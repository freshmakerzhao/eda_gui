// This defines the interface to the XsciLexerVHDL class.
 


#ifndef XSCILEXERVHDL_H
#define XSCILEXERVHDL_H
...
//! \brief The XsciLexerVHDL class encapsulates the Scintilla VHDL lexer.
class XSCINTILLA_EXPORT XsciLexerVHDL : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerVHDL with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
    XsciLexerVHDL(QObject *parent = 0);

    //! Destroys the XsciLexerVHDL instance.
    virtual ~XsciLexerVHDL();
...
private:
    ...
    XsciLexerVHDL(const XsciLexerVHDL &);
    XsciLexerVHDL &operator=(const XsciLexerVHDL &);
};
