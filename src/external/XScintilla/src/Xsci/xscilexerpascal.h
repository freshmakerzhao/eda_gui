// This defines the interface to the XsciLexerPascal class.
 


#ifndef XSCILEXERPASCAL_H
#define XSCILEXERPASCAL_H
...
//! \brief The XsciLexerPascal class encapsulates the Scintilla Pascal lexer.
class XSCINTILLA_EXPORT XsciLexerPascal : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerPascal with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
    XsciLexerPascal(QObject *parent = 0);

    //! Destroys the XsciLexerPascal instance.
    virtual ~XsciLexerPascal();
...
private:
    ...
    XsciLexerPascal(const XsciLexerPascal &);
    XsciLexerPascal &operator=(const XsciLexerPascal &);
};
