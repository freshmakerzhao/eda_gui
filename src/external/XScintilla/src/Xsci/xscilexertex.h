// This defines the interface to the XsciLexerTeX class.
 


#ifndef XSCILEXERTEX_H
#define XSCILEXERTEX_H
...
//! \brief The XsciLexerTeX class encapsulates the Scintilla TeX lexer.
class XSCINTILLA_EXPORT XsciLexerTeX : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerTeX with parent \a parent.  \a parent is typically
    //! the XsciScintilla instance.
    XsciLexerTeX(QObject *parent = 0);

    //! Destroys the XsciLexerTeX instance.
    virtual ~XsciLexerTeX();
...
private:
    ...
    XsciLexerTeX(const XsciLexerTeX &);
    XsciLexerTeX &operator=(const XsciLexerTeX &);
};
