// This defines the interface to the XsciLexerVerilog class.
 


#ifndef XSCILEXERVERILOG_H
#define XSCILEXERVERILOG_H
...
//! \brief The XsciLexerVerilog class encapsulates the Scintilla Verilog
//! lexer.
class XSCINTILLA_EXPORT XsciLexerVerilog : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerVerilog with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
    XsciLexerVerilog(QObject *parent = 0);

    //! Destroys the XsciLexerVerilog instance.
    virtual ~XsciLexerVerilog();
...
private:
    ...
    XsciLexerVerilog(const XsciLexerVerilog &);
    XsciLexerVerilog &operator=(const XsciLexerVerilog &);
};
