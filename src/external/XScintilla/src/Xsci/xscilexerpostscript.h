// This defines the interface to the XsciLexerPostScript class.
 


#ifndef XSCILEXERPOSTSCRIPT_H
#define XSCILEXERPOSTSCRIPT_H
...
//! \brief The XsciLexerPostScript class encapsulates the Scintilla PostScript
//! lexer.
class XSCINTILLA_EXPORT XsciLexerPostScript : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerPostScript with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
    XsciLexerPostScript(QObject *parent = 0);

    //! Destroys the XsciLexerPostScript instance.
    virtual ~XsciLexerPostScript();
...
private:
    ...
    XsciLexerPostScript(const XsciLexerPostScript &);
    XsciLexerPostScript &operator=(const XsciLexerPostScript &);
};
