// This defines the interface to the XsciLexerCMake class.
 


#ifndef XSCILEXERCMAKE_H
#define XSCILEXERCMAKE_H
...
//! \brief The XsciLexerCMake class encapsulates the Scintilla CMake lexer.
class XSCINTILLA_EXPORT XsciLexerCMake : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerCMake with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
    XsciLexerCMake(QObject *parent = 0);

    //! Destroys the XsciLexerCMake instance.
    virtual ~XsciLexerCMake();
...
private:
    ...
    XsciLexerCMake(const XsciLexerCMake &);
    XsciLexerCMake &operator=(const XsciLexerCMake &);
};
