// This defines the interface to the XsciLexerCPP class.
 


#ifndef XSCILEXERCPP_H
#define XSCILEXERCPP_H
...
//! \brief The XsciLexerCPP class encapsulates the Scintilla C++
//! lexer.
class XSCINTILLA_EXPORT XsciLexerCPP : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerCPP with parent \a parent.  \a parent is typically
    //! the XsciScintilla instance.  \a caseInsensitiveKeywords is true if the
    //! lexer ignores the case of keywords.
    XsciLexerCPP(QObject *parent = 0, bool caseInsensitiveKeywords = false);

    //! Destroys the XsciLexerCPP instance.
    virtual ~XsciLexerCPP();
...
private:
    ...
    XsciLexerCPP(const XsciLexerCPP &);
    XsciLexerCPP &operator=(const XsciLexerCPP &);
};
