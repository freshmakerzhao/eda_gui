// This defines the interface to the XsciLexerMarkdown class.
 


#ifndef XSCILEXERMARKDOWN_H
#define XSCILEXERMARKDOWN_H
...
//! \brief The XsciLexerMarkdown class encapsulates the Scintilla Markdown
//! lexer.
class XSCINTILLA_EXPORT XsciLexerMarkdown : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerMarkdown with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
    XsciLexerMarkdown(QObject *parent = 0);

    //! Destroys the XsciLexerMarkdown instance.
    virtual ~XsciLexerMarkdown();
...
private:
    XsciLexerMarkdown(const XsciLexerMarkdown &);
    XsciLexerMarkdown &operator=(const XsciLexerMarkdown &);
};
