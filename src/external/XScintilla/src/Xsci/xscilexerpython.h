// This defines the interface to the XsciLexerPython class.
 


#ifndef XSCILEXERPYTHON_H
#define XSCILEXERPYTHON_H
...
//! \brief The XsciLexerPython class encapsulates the Scintilla Python lexer.
class XSCINTILLA_EXPORT XsciLexerPython : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerPython with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
    XsciLexerPython(QObject *parent = 0);

    //! Destroys the XsciLexerPython instance.
    virtual ~XsciLexerPython();
    ...
    XsciLexerPython::IndentationWarning indentationWarning() const {return indent_warn;}
...
public slots:
    ...
    virtual void setIndentationWarning(XsciLexerPython::IndentationWarning warn);
...
private:
    ...
    XsciLexerPython(const XsciLexerPython &);
    XsciLexerPython &operator=(const XsciLexerPython &);
};
