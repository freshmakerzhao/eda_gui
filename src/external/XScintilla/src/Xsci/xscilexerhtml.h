// This defines the interface to the XsciLexerHTML class.
 


#ifndef XSCILEXERHTML_H
#define XSCILEXERHTML_H
...
//! \brief The XsciLexerHTML class encapsulates the Scintilla HTML lexer.
class XSCINTILLA_EXPORT XsciLexerHTML : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerHTML with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
    XsciLexerHTML(QObject *parent = 0);

    //! Destroys the XsciLexerHTML instance.
    virtual ~XsciLexerHTML();
...
private:
    ...
    XsciLexerHTML(const XsciLexerHTML &);
    XsciLexerHTML &operator=(const XsciLexerHTML &);
};
