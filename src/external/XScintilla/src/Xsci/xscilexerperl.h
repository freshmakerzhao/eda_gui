// This defines the interface to the XsciLexerPerl class.
 


#ifndef XSCILEXERPERL_H
#define XSCILEXERPERL_H
...
//! \brief The XsciLexerPerl class encapsulates the Scintilla Perl
//! lexer.
class XSCINTILLA_EXPORT XsciLexerPerl : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerPerl with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
    XsciLexerPerl(QObject *parent = 0);

    //! Destroys the XsciLexerPerl instance.
    virtual ~XsciLexerPerl();
...
private:
    ...
    XsciLexerPerl(const XsciLexerPerl &);
    XsciLexerPerl &operator=(const XsciLexerPerl &);
};
