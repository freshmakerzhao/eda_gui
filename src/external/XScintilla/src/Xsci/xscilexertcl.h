// This defines the interface to the XsciLexerTCL class.
 


#ifndef XSCILEXERTCL_H
#define XSCILEXERTCL_H
...
//! \brief The XsciLexerTCL class encapsulates the Scintilla TCL lexer.
class XSCINTILLA_EXPORT XsciLexerTCL : public XsciLexer
{
	Q_OBJECT
...
public:
	...
	//! Construct a XsciLexerTCL with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
	XsciLexerTCL(QObject *parent = 0);

	//! Destroys the XsciLexerTCL instance.
	virtual ~XsciLexerTCL();
...
private:
	...
	XsciLexerTCL(const XsciLexerTCL &);
	XsciLexerTCL &operator=(const XsciLexerTCL &);
};
