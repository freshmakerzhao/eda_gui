// This defines the interface to the XsciLexerCSS class.
 


#ifndef XSCILEXERCSS_H
#define XSCILEXERCSS_H
...
//! \brief The XsciLexerCSS class encapsulates the Scintilla CSS lexer.
class XSCINTILLA_EXPORT XsciLexerCSS : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerCSS with parent \a parent.  \a parent is typically
    //! the XsciScintilla instance.
    XsciLexerCSS(QObject *parent = 0);

    //! Destroys the XsciLexerCSS instance.
    virtual ~XsciLexerCSS();
...
private:
    ...
    XsciLexerCSS(const XsciLexerCSS &);
    XsciLexerCSS &operator=(const XsciLexerCSS &);
};
