// This defines the interface to the XsciLexerPOV class.
 


#ifndef XSCILEXERPOV_H
#define XSCILEXERPOV_H
...
//! \brief The XsciLexerPOV class encapsulates the Scintilla POV lexer.
class XSCINTILLA_EXPORT XsciLexerPOV : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerPOV with parent \a parent.  \a parent is typically
    //! the XsciScintilla instance.
    XsciLexerPOV(QObject *parent = 0);

    //! Destroys the XsciLexerPOV instance.
    virtual ~XsciLexerPOV();
...
private:
    ...
    XsciLexerPOV(const XsciLexerPOV &);
    XsciLexerPOV &operator=(const XsciLexerPOV &);
};
