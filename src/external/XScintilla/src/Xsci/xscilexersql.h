// This defines the interface to the XsciLexerSQL class.
 


#ifndef XSCILEXERSQL_H
#define XSCILEXERSQL_H
...
//! \brief The XsciLexerSQL class encapsulates the Scintilla SQL lexer.
class XSCINTILLA_EXPORT XsciLexerSQL : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerSQL with parent \a parent.  \a parent is typically
    //! the XsciScintilla instance.
    XsciLexerSQL(QObject *parent = 0);

    //! Destroys the XsciLexerSQL instance.
    virtual ~XsciLexerSQL();
...
private:
    ...
    XsciLexerSQL(const XsciLexerSQL &);
    XsciLexerSQL &operator=(const XsciLexerSQL &);
};
