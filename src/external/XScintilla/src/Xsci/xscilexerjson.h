// This defines the interface to the XsciLexerJSON class.
 


#ifndef XSCILEXERJSON_H
#define XSCILEXERJSON_H
...
//! \brief The XsciLexerJSON class encapsulates the Scintilla JSON lexer.
class XSCINTILLA_EXPORT XsciLexerJSON : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerJSON with parent \a parent.  \a parent is
    //! typically the XsciScintilla instance.
    XsciLexerJSON(QObject *parent = 0);

    //! Destroys the XsciLexerJSON instance.
    virtual ~XsciLexerJSON();
...
private:
    ...
    XsciLexerJSON(const XsciLexerJSON &);
    XsciLexerJSON &operator=(const XsciLexerJSON &);
};
