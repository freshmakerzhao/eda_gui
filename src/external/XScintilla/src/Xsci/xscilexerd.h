// This defines the interface to the XsciLexerD class.
...
//! \brief The XsciLexerD class encapsulates the Scintilla D lexer.
class XSCINTILLA_EXPORT XsciLexerD : public XsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a XsciLexerD with parent \a parent.  \a parent is typically
    //! the XsciScintilla instance.
    XsciLexerD(QObject *parent = 0);

    //! Destroys the XsciLexerD instance.
    virtual ~XsciLexerD();
...
private:
    ...
    XsciLexerD(const XsciLexerD &);
    XsciLexerD &operator=(const XsciLexerD &);
};
