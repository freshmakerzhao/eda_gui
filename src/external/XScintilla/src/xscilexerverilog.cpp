// This module implements the XsciLexerVerilog class.
 


#include "Xsci/xscilexerverilog.h"
...
// The ctor.
XsciLexerVerilog::XsciLexerVerilog(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerVerilog::~XsciLexerVerilog()
{
}


// Returns the language name.
const char *XsciLexerVerilog::language() const
{
    return "Verilog";
}
...
const char *XsciLexerVerilog::lexer() const
{
    return "verilog";
}
...
int XsciLexerVerilog::braceStyle() const
{
    return Operator;
}
...
const char *XsciLexerVerilog::keywords(int set) const
{
    if (set == 1)
        return
...
const char *XsciLexerVerilog::wordCharacters() const
{
...
QColor XsciLexerVerilog::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerVerilog::defaultEolFill(int style) const
{
    switch (style)
    {
    case CommentBang:
...
QFont XsciLexerVerilog::defaultFont(int style) const
{
    QFont f;
...
QString XsciLexerVerilog::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerVerilog::defaultPaper(int style) const
{
    switch (style)
    {
    case CommentBang:
...
void XsciLexerVerilog::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool XsciLexerVerilog::readProperties(QSettings &qs,const QString &prefix)
{
...
bool XsciLexerVerilog::writeProperties(QSettings &qs,const QString &prefix) const
{
...
void XsciLexerVerilog::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void XsciLexerVerilog::setAtElseProp()
{
...
void XsciLexerVerilog::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerVerilog::setCommentProp()
{
...
void XsciLexerVerilog::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerVerilog::setCompactProp()
{
...
void XsciLexerVerilog::setFoldPreprocessor(bool fold)
{
    fold_preproc = fold;
...
void XsciLexerVerilog::setPreprocProp()
{
...
void XsciLexerVerilog::setFoldAtModule(bool fold)
{
    fold_atmodule = fold;
...
void XsciLexerVerilog::setAtModuleProp()
{
