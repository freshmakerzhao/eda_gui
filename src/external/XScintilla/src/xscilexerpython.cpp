// This module implements the XsciLexerPython class.
 


#include "Xsci/xscilexerpython.h"
...
const char *XsciLexerPython::keywordClass =
...
// The ctor.
XsciLexerPython::XsciLexerPython(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerPython::~XsciLexerPython()
{
}


// Returns the language name.
const char *XsciLexerPython::language() const
{
    return "Python";
}
...
const char *XsciLexerPython::lexer() const
{
    return "python";
}
...
int XsciLexerPython::indentationGuideView() const
{
    return XsciScintillaBase::SC_IV_LOOKFORWARD;
}


// Return the set of character sequences that can separate auto-completion
// words.
QStringList XsciLexerPython::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *XsciLexerPython::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
int XsciLexerPython::blockLookback() const
{
...
int XsciLexerPython::braceStyle() const
{
    return Operator;
}
...
QColor XsciLexerPython::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerPython::defaultEolFill(int style) const
{
...
QFont XsciLexerPython::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerPython::keywords(int set) const
{
    if (set != 1)
        return 0;
...
QString XsciLexerPython::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerPython::defaultPaper(int style) const
{
    if (style == UnclosedString)
...
void XsciLexerPython::refreshProperties()
{
    setCommentProp();
    setCompactProp();
    setQuotesProp();
...
bool XsciLexerPython::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool XsciLexerPython::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
void XsciLexerPython::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerPython::setCommentProp()
{
...
void XsciLexerPython::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerPython::setCompactProp()
{
...
void XsciLexerPython::setFoldQuotes(bool fold)
{
    fold_quotes = fold;
...
void XsciLexerPython::setQuotesProp()
{
...
void XsciLexerPython::setIndentationWarning(XsciLexerPython::IndentationWarning warn)
{
    indent_warn = warn;
...
void XsciLexerPython::setTabWhingeProp()
{
...
void XsciLexerPython::setStringsOverNewlineAllowed(bool allowed)
{
...
void XsciLexerPython::setStringsOverNewlineProp()
{
...
void XsciLexerPython::setV2UnicodeAllowed(bool allowed)
{
    v2_unicode = allowed;
...
// Set the "lexer.python.strings.u" property.
void XsciLexerPython::setV2UnicodeProp()
{
...
void XsciLexerPython::setV3BinaryOctalAllowed(bool allowed)
{
...
void XsciLexerPython::setV3BinaryOctalProp()
{
...
void XsciLexerPython::setV3BytesAllowed(bool allowed)
{
    v3_bytes = allowed;
...
void XsciLexerPython::setV3BytesProp()
{
...
void XsciLexerPython::setHighlightSubidentifiers(bool enabled)
{
...
void XsciLexerPython::setHighlightSubidsProp()
{
