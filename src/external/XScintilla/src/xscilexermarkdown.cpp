// This module implements the XsciLexerMarkdown class.
 


#include "Xsci/xscilexermarkdown.h"

#include <qfont.h>


// The ctor.
XsciLexerMarkdown::XsciLexerMarkdown(QObject *parent)
    : XsciLexer(parent)
{
}
...
// The dtor.
XsciLexerMarkdown::~XsciLexerMarkdown()
{
}


// Returns the language name.
const char *XsciLexerMarkdown::language() const
{
    return "Markdown";
}
...
const char *XsciLexerMarkdown::lexer() const
{
    return "markdown";
}
...
QColor XsciLexerMarkdown::defaultColor(int style) const
{
    switch (style)
    {
    case Special:
...
QFont XsciLexerMarkdown::defaultFont(int style) const
{
    QFont f;
...
QColor XsciLexerMarkdown::defaultPaper(int style) const
{
    switch (style)
    {
    case Prechar:
...
QString XsciLexerMarkdown::description(int style) const
{
    switch (style)
    {
    case Default:
