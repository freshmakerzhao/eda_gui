...
static QList<XsciScintillaBase *> poolList;
...
// The ctor.
XsciScintillaBase::XsciScintillaBase(QWidget *parent)
...
#endif
{
    ...
    XsciAccessibleScintillaBase::initialise();
#endif
...
// The dtor.
XsciScintillaBase::~XsciScintillaBase()
{
    // The XsciScintillaQt object isn't a child so delete it explicitly.
    delete sci;
...
XsciScintillaBase *XsciScintillaBase::pool()
{
...
// itself.
void XsciScintillaBase::setScrollBars()
{
    sci->SetScrollBars();
}
...
// API.
long XsciScintillaBase::SendScintilla(unsigned int msg, unsigned long wParam,
        long lParam) const
{
...
// Overloaded message send.
long XsciScintillaBase::SendScintilla(unsigned int msg, uintptr_t wParam,
...
// Overloaded message send.
long XsciScintillaBase::SendScintilla(unsigned int msg,
        const char *lParam) const
{
...
// Overloaded message send.
long XsciScintillaBase::SendScintilla(unsigned int msg, const char *wParam,
        const char *lParam) const
{
...
// Overloaded message send.
long XsciScintillaBase::SendScintilla(unsigned int msg, long wParam) const
{
...
// Overloaded message send.
long XsciScintillaBase::SendScintilla(unsigned int msg, int wParam) const
{
    return sci->WndProc(msg, static_cast<uptr_t>(wParam),
            static_cast<sptr_t>(0));
}
...
// Overloaded message send.
long XsciScintillaBase::SendScintilla(unsigned int msg, long cpMin, long cpMax,
...
// Overloaded message send.
long XsciScintillaBase::SendScintilla(unsigned int msg, const QColor &col) const
{
...
void *XsciScintillaBase::SendScintillaPtrResult(unsigned int msg) const
{
...
void XsciScintillaBase::changeEvent(QEvent *e)
{
...
void XsciScintillaBase::contextMenuEvent(QContextMenuEvent *e)
{
...
void XsciScintillaBase::focusInEvent(QFocusEvent *e)
{
...
void XsciScintillaBase::focusOutEvent(QFocusEvent *e)
{
    if (e->reason() == Qt::ActiveWindowFocusReason)
    {
        ...
        if (!aw || aw->parent() != this || !aw->inherits("XsciSciListBox"))
...
bool XsciScintillaBase::focusNextPrevChild(bool next)
{
...
// Handle key presses.
void XsciScintillaBase::keyPressEvent(QKeyEvent *e)
{
    int modifiers = 0;
...
int XsciScintillaBase::commandKey(int qt_key, int &modifiers)
{
    int key;
...
XsciScintillaBase::ScintillaBytes XsciScintillaBase::textAsBytes(const QString &text) const
{
...
QString XsciScintillaBase::bytesAsText(const char *bytes) const
{
    if (sci->IsUnicodeMode())
...
void XsciScintillaBase::mouseDoubleClickEvent(QMouseEvent *e)
{
...
// Handle a mouse move.
void XsciScintillaBase::mouseMoveEvent(QMouseEvent *e)
{
...
void XsciScintillaBase::mousePressEvent(QMouseEvent *e)
{
    setFocus();
    ...
    if (e->button() == Qt::LeftButton || e->button() == Qt::RightButton)
    {
        ...
        if (e->button() == Qt::LeftButton)
            sci->ButtonDownWithModifiers(pt, clickTime,
                    XsciScintillaQt::ModifierFlags(shift, ctrl, alt));
        else
...
void XsciScintillaBase::mouseReleaseEvent(QMouseEvent *e)
{
    if (e->button() != Qt::LeftButton)
        return;
    ...
    if (sci->HaveMouseCapture())
    {
        ...
        sci->ButtonUpWithModifiers(pt, 0,
                XsciScintillaQt::ModifierFlags(false, ctrl, false));
    }
...
// Handle paint events.
void XsciScintillaBase::paintEvent(QPaintEvent *e)
{
    sci->paintEvent(e);
}
...
void XsciScintillaBase::resizeEvent(QResizeEvent *)
{
    sci->ChangeSize();
}
...
void XsciScintillaBase::scrollContentsBy(int, int)
{
}


// Handle the vertical scrollbar.
void XsciScintillaBase::handleVSb(int value)
{
    sci->ScrollTo(value);
}
...
void XsciScintillaBase::handleHSb(int value)
{
...
// Handle drag enters.
void XsciScintillaBase::dragEnterEvent(QDragEnterEvent *e)
{
    XsciScintillaBase::dragMoveEvent(e);
}


// Handle drag leaves.
void XsciScintillaBase::dragLeaveEvent(QDragLeaveEvent *)
{
...
// Handle drag moves.
void XsciScintillaBase::dragMoveEvent(QDragMoveEvent *e)
{
...
// Handle drops.
void XsciScintillaBase::dropEvent(QDropEvent *e)
{
    if (e->mimeData()->hasUrls())
    {
        e->acceptProposedAction();
...
void XsciScintillaBase::acceptAction(QDropEvent *e)
{
...
bool XsciScintillaBase::canInsertFromMimeData(const QMimeData *source) const
{
...
QByteArray XsciScintillaBase::fromMimeData(const QMimeData *source, bool &rectangular) const
{
...
QMimeData *XsciScintillaBase::toMimeData(const QByteArray &text, bool rectangular) const
{
...
void XsciScintillaBase::connectVerticalScrollBar()
{
...
void XsciScintillaBase::connectHorizontalScrollBar()
{
...
void XsciScintillaBase::replaceVerticalScrollBar(QScrollBar *scrollBar)
{
...
void XsciScintillaBase::replaceHorizontalScrollBar(QScrollBar *scrollBar)
{
...
// helper to XsciScintilla::contextMenuEvent().  A proper design would break
// backwards compatibility.
bool XsciScintillaBase::contextMenuNeeded(int x, int y) const
{
...
int XsciScintillaBase::eventModifiers(QMouseEvent *e)
{
    bool shift = e->modifiers() & Qt::ShiftModifier;
    bool ctrl = e->modifiers() & Qt::ControlModifier;
    bool alt = e->modifiers() & Qt::AltModifier;

    return XsciScintillaQt::ModifierFlags(shift, ctrl, alt);
}
