// This module implements the XsciLexerPOV class.
 


#include "Xsci/xscilexerpov.h"
...
// The ctor.
XsciLexerPOV::XsciLexerPOV(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerPOV::~XsciLexerPOV()
{
}


// Returns the language name.
const char *XsciLexerPOV::language() const
{
    return "POV";
}
...
const char *XsciLexerPOV::lexer() const
{
    return "pov";
}
...
int XsciLexerPOV::braceStyle() const
{
    return Operator;
}
...
const char *XsciLexerPOV::wordCharacters() const
{
...
QColor XsciLexerPOV::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerPOV::defaultEolFill(int style) const
{
...
QFont XsciLexerPOV::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerPOV::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerPOV::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerPOV::defaultPaper(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
void XsciLexerPOV::refreshProperties()
{
    setCommentProp();
    setCompactProp();
    setDirectiveProp();
...
bool XsciLexerPOV::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool XsciLexerPOV::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool XsciLexerPOV::foldComments() const
{
...
void XsciLexerPOV::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerPOV::setCommentProp()
{
...
bool XsciLexerPOV::foldCompact() const
{
    return fold_compact;
}
...
void XsciLexerPOV::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerPOV::setCompactProp()
{
...
bool XsciLexerPOV::foldDirectives() const
{
...
void XsciLexerPOV::setFoldDirectives(bool fold)
{
...
void XsciLexerPOV::setDirectiveProp()
{
