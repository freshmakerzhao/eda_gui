// This module implements the XsciLexerTCL class.
...
// The ctor.
XsciLexerTCL::XsciLexerTCL(QObject *parent)
...
// The dtor.
XsciLexerTCL::~XsciLexerTCL()
{
}


// Returns the language name.
const char *XsciLexerTCL::language() const
{
    return "TCL";
}
...
const char *XsciLexerTCL::lexer() const
{
    return "tcl";
}
...
int XsciLexerTCL::braceStyle() const
{
    return Operator;
}
...
QColor XsciLexerTCL::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerTCL::defaultEolFill(int style) const
{
    switch (style)
    {
    case QuotedString:
...
QFont XsciLexerTCL::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerTCL::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerTCL::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerTCL::defaultPaper(int style) const
{
    switch (style)
    {
    case Comment:
...
void XsciLexerTCL::refreshProperties()
{
    setCommentProp();
}
...
bool XsciLexerTCL::readProperties(QSettings &qs, const QString &prefix)
{
    int rc = true;
...
bool XsciLexerTCL::writeProperties(QSettings &qs, const QString &prefix) const
{
    int rc = true;
...
void XsciLexerTCL::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerTCL::setCommentProp()
{
