// This module implements the XsciLexerFortran77 class.
...
// The ctor.
XsciLexerFortran77::XsciLexerFortran77(QObject *parent)
...
// The dtor.
XsciLexerFortran77::~XsciLexerFortran77()
{
}


// Returns the language name.
const char *XsciLexerFortran77::language() const
{
    return "Fortran77";
}
...
const char *XsciLexerFortran77::lexer() const
{
    return "f77";
}
...
int XsciLexerFortran77::braceStyle() const
{
    return Default;
}
...
QColor XsciLexerFortran77::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerFortran77::defaultEolFill(int style) const
{
...
QFont XsciLexerFortran77::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerFortran77::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerFortran77::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerFortran77::defaultPaper(int style) const
{
    if (style == UnclosedString)
        return QColor(0xe0,0xc0,0xe0);
...
void XsciLexerFortran77::refreshProperties()
{
    setCompactProp();
}
...
bool XsciLexerFortran77::readProperties(QSettings &qs, const QString &prefix)
{
    int rc = true;
...
bool XsciLexerFortran77::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool XsciLexerFortran77::foldCompact() const
{
    return fold_compact;
}
...
void XsciLexerFortran77::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerFortran77::setCompactProp()
{
