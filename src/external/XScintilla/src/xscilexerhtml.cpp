// This module implements the XsciLexerHTML class.
...
// The ctor.
XsciLexerHTML::XsciLexerHTML(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerHTML::~XsciLexerHTML()
{
}


// Returns the language name.
const char *XsciLexerHTML::language() const
{
    return "HTML";
}
...
const char *XsciLexerHTML::lexer() const
{
    return "hypertext";
}
...
const char *XsciLexerHTML::autoCompletionFillups() const
{
    return "/>";
}
...
const char *XsciLexerHTML::wordCharacters() const
{
...
QColor XsciLexerHTML::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerHTML::defaultEolFill(int style) const
{
    switch (style)
    {
    case JavaScriptDefault:
...
QFont XsciLexerHTML::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerHTML::keywords(int set) const
{
    if (set == 1)
        return
    ...
    if (set == 2)
        return XsciLexerJavaScript::keywordClass;

    if (set == 3)
        return
            // Move these to XsciLexerVisualBasic when we
    ...
    if (set == 4)
        return XsciLexerPython::keywordClass;
...
QString XsciLexerHTML::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerHTML::defaultPaper(int style) const
{
    switch (style)
    {
    case ASPAtStart:
...
void XsciLexerHTML::refreshProperties()
{
    setCompactProp();
    setPreprocProp();
    setCaseSensTagsProp();
...
bool XsciLexerHTML::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool XsciLexerHTML::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
void XsciLexerHTML::setCaseSensitiveTags(bool sens)
{
    case_sens_tags = sens;
...
void XsciLexerHTML::setCaseSensTagsProp()
{
...
void XsciLexerHTML::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerHTML::setCompactProp()
{
...
void XsciLexerHTML::setFoldPreprocessor(bool fold)
{
    fold_preproc = fold;
...
void XsciLexerHTML::setPreprocProp()
{
...
void XsciLexerHTML::setFoldScriptComments(bool fold)
{
...
void XsciLexerHTML::setScriptCommentsProp()
{
...
void XsciLexerHTML::setFoldScriptHeredocs(bool fold)
{
...
void XsciLexerHTML::setScriptHeredocsProp()
{
...
void XsciLexerHTML::setDjangoTemplates(bool enable)
{
...
void XsciLexerHTML::setDjangoProp()
{
...
void XsciLexerHTML::setMakoTemplates(bool enable)
{
...
void XsciLexerHTML::setMakoProp()
{
