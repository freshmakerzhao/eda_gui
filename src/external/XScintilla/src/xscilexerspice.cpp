// This module implements the XsciLexerSpice class.
 


#include "Xsci/xscilexerspice.h"
...
// The ctor.
XsciLexerSpice::XsciLexerSpice(QObject *parent)
    : XsciLexer(parent)
{
}
...
// The dtor.
XsciLexerSpice::~XsciLexerSpice()
{
}


// Returns the language name.
const char *XsciLexerSpice::language() const
{
    return "Spice";
}
...
const char *XsciLexerSpice::lexer() const
{
    return "spice";
}
...
int XsciLexerSpice::braceStyle() const
{
    return Parameter;
}
...
const char *XsciLexerSpice::keywords(int set) const
{
    if (set == 1)
        return
...
QColor XsciLexerSpice::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
QFont XsciLexerSpice::defaultFont(int style) const
{
    QFont f;
...
QString XsciLexerSpice::description(int style) const
{
    switch (style)
    {
    case Default:
