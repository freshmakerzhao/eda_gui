// This module implements the XsciLexerBash class.
 


#include "Xsci/xscilexerbash.h"
...
// The ctor.
XsciLexerBash::XsciLexerBash(QObject *parent)
...
// The dtor.
XsciLexerBash::~XsciLexerBash()
{
}


// Returns the language name.
const char *XsciLexerBash::language() const
{
    return "Bash";
}
...
const char *XsciLexerBash::lexer() const
{
    return "bash";
}
...
int XsciLexerBash::braceStyle() const
{
    return Operator;
}
...
const char *XsciLexerBash::wordCharacters() const
{
...
QColor XsciLexerBash::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerBash::defaultEolFill(int style) const
{
    switch (style)
    {
    case SingleQuotedHereDocument:
...
QFont XsciLexerBash::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerBash::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerBash::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerBash::defaultPaper(int style) const
{
    switch (style)
    {
    case Error:
...
void XsciLexerBash::refreshProperties()
{
    setCommentProp();
    setCompactProp();
}
...
bool XsciLexerBash::readProperties(QSettings &qs, const QString &prefix)
{
    int rc = true;
...
bool XsciLexerBash::writeProperties(QSettings &qs, const QString &prefix) const
{
    int rc = true;
...
bool XsciLexerBash::foldComments() const
{
...
void XsciLexerBash::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerBash::setCommentProp()
{
...
bool XsciLexerBash::foldCompact() const
{
    return fold_compact;
}
...
void XsciLexerBash::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerBash::setCompactProp()
{
