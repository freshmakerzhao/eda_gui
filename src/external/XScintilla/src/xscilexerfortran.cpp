// This module implements the XsciLexerFortran class.
 


#include "Xsci/xscilexerfortran.h"
...
// The ctor.
XsciLexerFortran::XsciLexerFortran(QObject *parent)
    : XsciLexerFortran77(parent)
{
}


// The dtor.
XsciLexerFortran::~XsciLexerFortran()
{
}


// Returns the language name.
const char *XsciLexerFortran::language() const
{
    return "Fortran";
}
...
const char *XsciLexerFortran::lexer() const
{
    return "fortran";
}
...
const char *XsciLexerFortran::keywords(int set) const
{
    if (set == 2)
        return
    ...
    return XsciLexerFortran77::keywords(set);
}
