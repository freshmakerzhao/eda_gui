// This module implements the XsciLexerD class.
 


#include "Xsci/xscilexerd.h"
...
// The ctor.
XsciLexerD::XsciLexerD(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerD::~XsciLexerD()
{
}


// Returns the language name.
const char *XsciLexerD::language() const
{
    return "D";
}
...
const char *XsciLexerD::lexer() const
{
    return "d";
}
...
// words.
QStringList XsciLexerD::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *XsciLexerD::blockStartKeyword(int *style) const
{
    if (style)
        *style = Keyword;
...
const char *XsciLexerD::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
const char *XsciLexerD::blockEnd(int *style) const
{
    if (style)
        *style = Operator;
...
int XsciLexerD::braceStyle() const
{
    return Operator;
}
...
const char *XsciLexerD::wordCharacters() const
{
...
QColor XsciLexerD::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerD::defaultEolFill(int style) const
{
...
QFont XsciLexerD::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerD::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerD::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerD::defaultPaper(int style) const
{
    if (style == UnclosedString)
...
void XsciLexerD::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool XsciLexerD::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool XsciLexerD::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool XsciLexerD::foldAtElse() const
{
    return fold_atelse;
}
...
void XsciLexerD::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
bool XsciLexerD::foldComments() const
{
...
void XsciLexerD::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerD::setCommentProp()
{
...
bool XsciLexerD::foldCompact() const
{
    return fold_compact;
}
...
void XsciLexerD::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerD::setCompactProp()
{
