// This module implements the XsciLexerAVS class.
 


#include "Xsci/xscilexeravs.h"
...
// The ctor.
XsciLexerAVS::XsciLexerAVS(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerAVS::~XsciLexerAVS()
{
}


// Returns the language name.
const char *XsciLexerAVS::language() const
{
    return "AVS";
}
...
const char *XsciLexerAVS::lexer() const
{
    return "avs";
}
...
int XsciLexerAVS::braceStyle() const
{
    return Operator;
}
...
const char *XsciLexerAVS::wordCharacters() const
{
...
QColor XsciLexerAVS::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
QFont XsciLexerAVS::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerAVS::keywords(int set) const
{
    if (set == 1)
...
QString XsciLexerAVS::description(int style) const
{
    switch (style)
    {
    case Default:
...
void XsciLexerAVS::refreshProperties()
{
    setCommentProp();
    setCompactProp();
}
...
bool XsciLexerAVS::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool XsciLexerAVS::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool XsciLexerAVS::foldComments() const
{
...
void XsciLexerAVS::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerAVS::setCommentProp()
{
...
bool XsciLexerAVS::foldCompact() const
{
    return fold_compact;
}
...
void XsciLexerAVS::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerAVS::setCompactProp()
{
