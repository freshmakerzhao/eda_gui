// This module implements the XsciLexerCMake class.
 


#include "Xsci/xscilexercmake.h"
...
// The ctor.
XsciLexerCMake::XsciLexerCMake(QObject *parent)
    : XsciLexer(parent), fold_atelse(false)
{
}


// The dtor.
XsciLexerCMake::~XsciLexerCMake()
{
}


// Returns the language name.
const char *XsciLexerCMake::language() const
{
    return "CMake";
}
...
const char *XsciLexerCMake::lexer() const
{
    return "cmake";
}
...
QColor XsciLexerCMake::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
QFont XsciLexerCMake::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerCMake::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerCMake::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerCMake::defaultPaper(int style) const
{
    switch (style)
    {
    case String:
...
void XsciLexerCMake::refreshProperties()
{
    setAtElseProp();
}
...
bool XsciLexerCMake::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool XsciLexerCMake::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool XsciLexerCMake::foldAtElse() const
{
    return fold_atelse;
}
...
void XsciLexerCMake::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void XsciLexerCMake::setAtElseProp()
{
