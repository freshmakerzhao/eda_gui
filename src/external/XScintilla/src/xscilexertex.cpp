// This module implements the XsciLexerTeX class.
 


#include "Xsci/xscilexertex.h"
...
// The ctor.
XsciLexerTeX::XsciLexerTeX(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerTeX::~XsciLexerTeX()
{
}


// Returns the language name.
const char *XsciLexerTeX::language() const
{
    return "TeX";
}
...
const char *XsciLexerTeX::lexer() const
{
    return "tex";
}
...
const char *XsciLexerTeX::wordCharacters() const
{
...
QColor XsciLexerTeX::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
const char *XsciLexerTeX::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerTeX::description(int style) const
{
    switch (style)
    {
    case Default:
...
void XsciLexerTeX::refreshProperties()
{
    setCommentProp();
    setCompactProp();
...
bool XsciLexerTeX::readProperties(QSettings &qs, const QString &prefix)
{
    int rc = true;
...
bool XsciLexerTeX::writeProperties(QSettings &qs, const QString &prefix) const
{
    int rc = true;
...
void XsciLexerTeX::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerTeX::setCommentProp()
{
...
void XsciLexerTeX::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerTeX::setCompactProp()
{
...
void XsciLexerTeX::setProcessComments(bool enable)
{
...
void XsciLexerTeX::setProcessCommentsProp()
{
...
void XsciLexerTeX::setProcessIf(bool enable)
{
    process_if = enable;
...
void XsciLexerTeX::setAutoIfProp()
{
