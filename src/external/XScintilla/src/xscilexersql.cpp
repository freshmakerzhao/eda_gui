// This module implements the XsciLexerSQL class.
 


#include "Xsci/xscilexersql.h"
...
// The ctor.
XsciLexerSQL::XsciLexerSQL(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerSQL::~XsciLexerSQL()
{
}


// Returns the language name.
const char *XsciLexerSQL::language() const
{
    return "SQL";
}
...
const char *XsciLexerSQL::lexer() const
{
    return "sql";
}
...
int XsciLexerSQL::braceStyle() const
{
    return Operator;
}
...
QColor XsciLexerSQL::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerSQL::defaultEolFill(int style) const
{
    if (style == PlusPrompt)
        return true;
...
QFont XsciLexerSQL::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerSQL::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerSQL::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerSQL::defaultPaper(int style) const
{
    if (style == PlusPrompt)
...
void XsciLexerSQL::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool XsciLexerSQL::readProperties(QSettings &qs, const QString &prefix)
{
    int rc = true;
...
bool XsciLexerSQL::writeProperties(QSettings &qs, const QString &prefix) const
{
    int rc = true;
...
void XsciLexerSQL::setFoldAtElse(bool fold)
{
    at_else = fold;
...
void XsciLexerSQL::setAtElseProp()
{
...
void XsciLexerSQL::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerSQL::setCommentProp()
{
...
void XsciLexerSQL::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerSQL::setCompactProp()
{
...
void XsciLexerSQL::setFoldOnlyBegin(bool fold)
{
    only_begin = fold;
...
void XsciLexerSQL::setOnlyBeginProp()
{
...
void XsciLexerSQL::setQuotedIdentifiers(bool enable)
{
...
void XsciLexerSQL::setBackticksIdentifierProp()
{
...
void XsciLexerSQL::setHashComments(bool enable)
{
...
void XsciLexerSQL::setNumbersignCommentProp()
{
...
void XsciLexerSQL::setBackslashEscapes(bool enable)
{
...
void XsciLexerSQL::setBackslashEscapesProp()
{
...
// Enable dotted words.
void XsciLexerSQL::setDottedWords(bool enable)
{
...
void XsciLexerSQL::setAllowDottedWordProp()
{
