// This module implements the XsciLexerPerl class.
 


#include "Xsci/xscilexerperl.h"
...
// The ctor.
XsciLexerPerl::XsciLexerPerl(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerPerl::~XsciLexerPerl()
{
}


// Returns the language name.
const char *XsciLexerPerl::language() const
{
    return "Perl";
}
...
const char *XsciLexerPerl::lexer() const
{
    return "perl";
}
...
// words.
QStringList XsciLexerPerl::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *XsciLexerPerl::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
const char *XsciLexerPerl::blockEnd(int *style) const
{
    if (style)
        *style = Operator;
...
int XsciLexerPerl::braceStyle() const
{
    return Operator;
}
...
const char *XsciLexerPerl::wordCharacters() const
{
...
QColor XsciLexerPerl::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerPerl::defaultEolFill(int style) const
{
    switch (style)
    {
    case POD:
...
QFont XsciLexerPerl::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerPerl::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerPerl::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerPerl::defaultPaper(int style) const
{
    switch (style)
    {
    case Error:
...
void XsciLexerPerl::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool XsciLexerPerl::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool XsciLexerPerl::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool XsciLexerPerl::foldComments() const
{
...
void XsciLexerPerl::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerPerl::setCommentProp()
{
...
bool XsciLexerPerl::foldCompact() const
{
    return fold_compact;
}
...
void XsciLexerPerl::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerPerl::setCompactProp()
{
...
bool XsciLexerPerl::foldPackages() const
{
...
void XsciLexerPerl::setFoldPackages(bool fold)
{
    fold_packages = fold;
...
void XsciLexerPerl::setPackagesProp()
{
...
bool XsciLexerPerl::foldPODBlocks() const
{
...
void XsciLexerPerl::setFoldPODBlocks(bool fold)
{
...
void XsciLexerPerl::setPODBlocksProp()
{
...
void XsciLexerPerl::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void XsciLexerPerl::setAtElseProp()
{
