// This module implements the XsciLexerCoffeeScript class.
 


#include "Xsci/xscilexercoffeescript.h"
...
// The ctor.
XsciLexerCoffeeScript::XsciLexerCoffeeScript(QObject *parent)
    : XsciLexer(parent),
...
// The dtor.
XsciLexerCoffeeScript::~XsciLexerCoffeeScript()
{
}


// Returns the language name.
const char *XsciLexerCoffeeScript::language() const
{
    return "CoffeeScript";
}
...
const char *XsciLexerCoffeeScript::lexer() const
{
    return "coffeescript";
}
...
// words.
QStringList XsciLexerCoffeeScript::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *XsciLexerCoffeeScript::blockStartKeyword(int *style) const
{
    if (style)
        *style = Keyword;
...
const char *XsciLexerCoffeeScript::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
const char *XsciLexerCoffeeScript::blockEnd(int *style) const
{
    if (style)
        *style = Operator;
...
int XsciLexerCoffeeScript::braceStyle() const
{
    return Operator;
}
...
const char *XsciLexerCoffeeScript::wordCharacters() const
{
...
QColor XsciLexerCoffeeScript::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool XsciLexerCoffeeScript::defaultEolFill(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
QFont XsciLexerCoffeeScript::defaultFont(int style) const
{
    QFont f;
...
const char *XsciLexerCoffeeScript::keywords(int set) const
{
    if (set == 1)
        return
...
QString XsciLexerCoffeeScript::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor XsciLexerCoffeeScript::defaultPaper(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
void XsciLexerCoffeeScript::refreshProperties()
{
    setCommentProp();
    setCompactProp();
    setStylePreprocProp();
...
bool XsciLexerCoffeeScript::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool XsciLexerCoffeeScript::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
void XsciLexerCoffeeScript::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void XsciLexerCoffeeScript::setCommentProp()
{
...
void XsciLexerCoffeeScript::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void XsciLexerCoffeeScript::setCompactProp()
{
...
void XsciLexerCoffeeScript::setStylePreprocessor(bool style)
{
    style_preproc = style;
...
void XsciLexerCoffeeScript::setStylePreprocProp()
{
...
void XsciLexerCoffeeScript::setDollarsAllowed(bool allowed)
{
    dollars = allowed;
...
void XsciLexerCoffeeScript::setDollarsProp()
{
