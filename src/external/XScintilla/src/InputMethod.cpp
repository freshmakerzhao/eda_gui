...
static void MoveImeCarets(XsciScintillaQt *sqt, int offset)
{
...
static void DrawImeIndicator(XsciScintillaQt *sqt, int indicator, int len)
{
...
void XsciScintillaBase::inputMethodEvent(QInputMethodEvent *event)
{
...
QVariant XsciScintillaBase::inputMethodQuery(Qt::InputMethodQuery query) const
{
