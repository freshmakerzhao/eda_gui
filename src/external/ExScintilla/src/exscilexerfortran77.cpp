// This module implements the ExsciLexerFortran77 class.
...
// The ctor.
ExsciLexerFortran77::ExsciLexerFortran77(QObject *parent)
...
// The dtor.
ExsciLexerFortran77::~ExsciLexerFortran77()
{
}


// Returns the language name.
const char *ExsciLexerFortran77::language() const
{
    return "Fortran77";
}
...
const char *ExsciLexerFortran77::lexer() const
{
    return "f77";
}
...
int ExsciLexerFortran77::braceStyle() const
{
    return Default;
}
...
QColor ExsciLexerFortran77::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool ExsciLexerFortran77::defaultEolFill(int style) const
{
...
QFont ExsciLexerFortran77::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerFortran77::keywords(int set) const
{
    if (set == 1)
        return
...
QString ExsciLexerFortran77::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerFortran77::defaultPaper(int style) const
{
    if (style == UnclosedString)
        return QColor(0xe0,0xc0,0xe0);
...
void ExsciLexerFortran77::refreshProperties()
{
    setCompactProp();
}
...
bool ExsciLexerFortran77::readProperties(QSettings &qs, const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerFortran77::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool ExsciLexerFortran77::foldCompact() const
{
    return fold_compact;
}
...
void ExsciLexerFortran77::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerFortran77::setCompactProp()
{
