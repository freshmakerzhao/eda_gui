// This module implements the ExsciLexerTeX class.



#include "Exsci/exscilexertex.h"
...
// The ctor.
ExsciLexerTeX::ExsciLexerTeX(QObject *parent)
    : ExsciLexer(parent),
...
// The dtor.
ExsciLexerTeX::~ExsciLexerTeX()
{
}


// Returns the language name.
const char *ExsciLexerTeX::language() const
{
    return "TeX";
}
...
const char *ExsciLexerTeX::lexer() const
{
    return "tex";
}
...
const char *ExsciLexerTeX::wordCharacters() const
{
...
QColor ExsciLexerTeX::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
const char *ExsciLexerTeX::keywords(int set) const
{
    if (set == 1)
        return
...
QString ExsciLexerTeX::description(int style) const
{
    switch (style)
    {
    case Default:
...
void ExsciLexerTeX::refreshProperties()
{
    setCommentProp();
    setCompactProp();
...
bool ExsciLexerTeX::readProperties(QSettings &qs, const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerTeX::writeProperties(QSettings &qs, const QString &prefix) const
{
    int rc = true;
...
void ExsciLexerTeX::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void ExsciLexerTeX::setCommentProp()
{
...
void ExsciLexerTeX::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerTeX::setCompactProp()
{
...
void ExsciLexerTeX::setProcessComments(bool enable)
{
...
void ExsciLexerTeX::setProcessCommentsProp()
{
...
void ExsciLexerTeX::setProcessIf(bool enable)
{
    process_if = enable;
...
void ExsciLexerTeX::setAutoIfProp()
{
