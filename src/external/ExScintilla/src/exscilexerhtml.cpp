// This module implements the ExsciLexerHTML class.



#include "Exsci/exscilexerhtml.h"
...
// The ctor.
ExsciLexerHTML::ExsciLexerHTML(QObject *parent)
    : ExsciLexer(parent),
...
// The dtor.
ExsciLexerHTML::~ExsciLexerHTML()
{
}


// Returns the language name.
const char *ExsciLexerHTML::language() const
{
    return "HTML";
}
...
const char *ExsciLexerHTML::lexer() const
{
    return "hypertext";
}
...
const char *ExsciLexerHTML::autoCompletionFillups() const
{
    return "/>";
}
...
const char *ExsciLexerHTML::wordCharacters() const
{
...
QColor ExsciLexerHTML::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool ExsciLexerHTML::defaultEolFill(int style) const
{
    switch (style)
    {
    case JavaScriptDefault:
...
QFont ExsciLexerHTML::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerHTML::keywords(int set) const
{
    if (set == 1)
        return
    ...
    if (set == 2)
        return ExsciLexerJavaScript::keywordClass;

    if (set == 3)
        return
            // Move these to ExsciLexerVisualBasic when we
    ...
    if (set == 4)
        return ExsciLexerPython::keywordClass;
...
QString ExsciLexerHTML::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerHTML::defaultPaper(int style) const
{
    switch (style)
    {
    case ASPAtStart:
...
void ExsciLexerHTML::refreshProperties()
{
    setCompactProp();
    setPreprocProp();
    setCaseSensTagsProp();
...
bool ExsciLexerHTML::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerHTML::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
void ExsciLexerHTML::setCaseSensitiveTags(bool sens)
{
    case_sens_tags = sens;
...
void ExsciLexerHTML::setCaseSensTagsProp()
{
...
void ExsciLexerHTML::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerHTML::setCompactProp()
{
...
void ExsciLexerHTML::setFoldPreprocessor(bool fold)
{
    fold_preproc = fold;
...
void ExsciLexerHTML::setPreprocProp()
{
...
void ExsciLexerHTML::setFoldScriptComments(bool fold)
{
...
void ExsciLexerHTML::setScriptCommentsProp()
{
...
void ExsciLexerHTML::setFoldScriptHeredocs(bool fold)
{
...
void ExsciLexerHTML::setScriptHeredocsProp()
{
...
void ExsciLexerHTML::setDjangoTemplates(bool enable)
{
...
void ExsciLexerHTML::setDjangoProp()
{
...
void ExsciLexerHTML::setMakoTemplates(bool enable)
{
...
void ExsciLexerHTML::setMakoProp()
{
