// This module implements the ExsciLexerAVS class.



#include "Exsci/exscilexeravs.h"
...
// The ctor.
ExsciLexerAVS::ExsciLexerAVS(QObject *parent)
    : ExsciLexer(parent),
...
// The dtor.
ExsciLexerAVS::~ExsciLexerAVS()
{
}


// Returns the language name.
const char *ExsciLexerAVS::language() const
{
    return "AVS";
}
...
const char *ExsciLexerAVS::lexer() const
{
    return "avs";
}
...
int ExsciLexerAVS::braceStyle() const
{
    return Operator;
}
...
const char *ExsciLexerAVS::wordCharacters() const
{
...
QColor ExsciLexerAVS::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
QFont ExsciLexerAVS::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerAVS::keywords(int set) const
{
    if (set == 1)
...
QString ExsciLexerAVS::description(int style) const
{
    switch (style)
    {
    case Default:
...
void ExsciLexerAVS::refreshProperties()
{
    setCommentProp();
    setCompactProp();
}
...
bool ExsciLexerAVS::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerAVS::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool ExsciLexerAVS::foldComments() const
{
...
void ExsciLexerAVS::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void ExsciLexerAVS::setCommentProp()
{
...
bool ExsciLexerAVS::foldCompact() const
{
    return fold_compact;
}
...
void ExsciLexerAVS::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerAVS::setCompactProp()
{
