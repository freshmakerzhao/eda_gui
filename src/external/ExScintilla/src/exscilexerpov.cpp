// This module implements the ExsciLexerPOV class.



#include "Exsci/exscilexerpov.h"
...
// The ctor.
ExsciLexerPOV::ExsciLexerPOV(QObject *parent)
    : ExsciLexer(parent),
...
// The dtor.
ExsciLexerPOV::~ExsciLexerPOV()
{
}


// Returns the language name.
const char *ExsciLexerPOV::language() const
{
    return "POV";
}
...
const char *ExsciLexerPOV::lexer() const
{
    return "pov";
}
...
int ExsciLexerPOV::braceStyle() const
{
    return Operator;
}
...
const char *ExsciLexerPOV::wordCharacters() const
{
...
QColor ExsciLexerPOV::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool ExsciLexerPOV::defaultEolFill(int style) const
{
...
QFont ExsciLexerPOV::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerPOV::keywords(int set) const
{
    if (set == 1)
        return
...
QString ExsciLexerPOV::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerPOV::defaultPaper(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
void ExsciLexerPOV::refreshProperties()
{
    setCommentProp();
    setCompactProp();
    setDirectiveProp();
...
bool ExsciLexerPOV::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerPOV::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool ExsciLexerPOV::foldComments() const
{
...
void ExsciLexerPOV::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void ExsciLexerPOV::setCommentProp()
{
...
bool ExsciLexerPOV::foldCompact() const
{
    return fold_compact;
}
...
void ExsciLexerPOV::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerPOV::setCompactProp()
{
...
bool ExsciLexerPOV::foldDirectives() const
{
...
void ExsciLexerPOV::setFoldDirectives(bool fold)
{
...
void ExsciLexerPOV::setDirectiveProp()
{
