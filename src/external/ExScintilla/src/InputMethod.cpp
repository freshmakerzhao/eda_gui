...
static void MoveImeCarets(ExsciScintillaQt *sqt, int offset)
{
...
static void DrawImeIndicator(ExsciScintillaQt *sqt, int indicator, int len)
{
...
void ExsciScintillaBase::inputMethodEvent(QInputMethodEvent *event)
{
...
QVariant ExsciScintillaBase::inputMethodQuery(Qt::InputMethodQuery query) const
{
    ...
    switch (query) {
        ...
        case Qt::ImMicroFocus:
        {
            ...
            EXSCI_SCI_NAMESPACE(Point) pt = sci->LocationFromPosition(startPos);
