// This module implements the ExsciLexerVerilog class.



#include "Exsci/exscilexerverilog.h"
...
// The ctor.
ExsciLexerVerilog::ExsciLexerVerilog(QObject *parent)
    : ExsciLexer(parent),
...
// The dtor.
ExsciLexerVerilog::~ExsciLexerVerilog()
{
}


// Returns the language name.
const char *ExsciLexerVerilog::language() const
{
    return "Verilog";
}
...
const char *ExsciLexerVerilog::lexer() const
{
    return "verilog";
}
...
int ExsciLexerVerilog::braceStyle() const
{
    return Operator;
}
...
const char *ExsciLexerVerilog::keywords(int set) const
{
    if (set == 1)
        return
...
const char *ExsciLexerVerilog::wordCharacters() const
{
...
QColor ExsciLexerVerilog::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool ExsciLexerVerilog::defaultEolFill(int style) const
{
    switch (style)
    {
    case CommentBang:
...
QFont ExsciLexerVerilog::defaultFont(int style) const
{
    QFont f;
...
QString ExsciLexerVerilog::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerVerilog::defaultPaper(int style) const
{
    switch (style)
    {
    case CommentBang:
...
void ExsciLexerVerilog::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool ExsciLexerVerilog::readProperties(QSettings &qs,const QString &prefix)
{
...
bool ExsciLexerVerilog::writeProperties(QSettings &qs,const QString &prefix) const
{
...
void ExsciLexerVerilog::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void ExsciLexerVerilog::setAtElseProp()
{
...
void ExsciLexerVerilog::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void ExsciLexerVerilog::setCommentProp()
{
...
void ExsciLexerVerilog::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerVerilog::setCompactProp()
{
...
void ExsciLexerVerilog::setFoldPreprocessor(bool fold)
{
    fold_preproc = fold;
...
void ExsciLexerVerilog::setPreprocProp()
{
...
void ExsciLexerVerilog::setFoldAtModule(bool fold)
{
    fold_atmodule = fold;
...
void ExsciLexerVerilog::setAtModuleProp()
{
