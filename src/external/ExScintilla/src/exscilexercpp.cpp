// This module implements the ExsciLexerCPP class.
...
// The ctor.
ExsciLexerCPP::ExsciLexerCPP(QObject *parent, bool caseInsensitiveKeywords)
    : ExsciLexer(parent),
...
// The dtor.
ExsciLexerCPP::~ExsciLexerCPP()
{
}


// Returns the language name.
const char *ExsciLexerCPP::language() const
{
    return "C++";
}
...
const char *ExsciLexerCPP::lexer() const
{
...
// words.
QStringList ExsciLexerCPP::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *ExsciLexerCPP::blockStartKeyword(int *style) const
{
    if (style)
        *style = Keyword;
...
const char *ExsciLexerCPP::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
const char *ExsciLexerCPP::blockEnd(int *style) const
{
    if (style)
        *style = Operator;
...
int ExsciLexerCPP::braceStyle() const
{
    return Operator;
}
...
const char *ExsciLexerCPP::wordCharacters() const
{
...
QColor ExsciLexerCPP::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool ExsciLexerCPP::defaultEolFill(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
QFont ExsciLexerCPP::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerCPP::keywords(int set) const
{
    if (set == 1)
        return
...
QString ExsciLexerCPP::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerCPP::defaultPaper(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
void ExsciLexerCPP::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool ExsciLexerCPP::readProperties(QSettings &qs,const QString &prefix)
{
...
bool ExsciLexerCPP::writeProperties(QSettings &qs,const QString &prefix) const
{
...
void ExsciLexerCPP::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void ExsciLexerCPP::setAtElseProp()
{
...
void ExsciLexerCPP::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void ExsciLexerCPP::setCommentProp()
{
...
void ExsciLexerCPP::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerCPP::setCompactProp()
{
...
void ExsciLexerCPP::setFoldPreprocessor(bool fold)
{
    fold_preproc = fold;
...
void ExsciLexerCPP::setPreprocProp()
{
...
void ExsciLexerCPP::setStylePreprocessor(bool style)
{
    style_preproc = style;
...
void ExsciLexerCPP::setStylePreprocProp()
{
...
void ExsciLexerCPP::setDollarsAllowed(bool allowed)
{
    dollars = allowed;
...
void ExsciLexerCPP::setDollarsProp()
{
...
void ExsciLexerCPP::setHighlightTripleQuotedStrings(bool enabled)
{
...
void ExsciLexerCPP::setHighlightTripleProp()
{
...
void ExsciLexerCPP::setHighlightHashQuotedStrings(bool enabled)
{
...
void ExsciLexerCPP::setHighlightHashProp()
{
...
void ExsciLexerCPP::setHighlightBackQuotedStrings(bool enabled)
{
...
void ExsciLexerCPP::setHighlightBackProp()
{
...
void ExsciLexerCPP::setHighlightEscapeSequences(bool enabled)
{
...
void ExsciLexerCPP::setHighlightEscapeProp()
{
...
void ExsciLexerCPP::setVerbatimStringEscapeSequencesAllowed(bool allowed)
{
    vs_escape = allowed;
...
void ExsciLexerCPP::setVerbatimStringEscapeProp()
{
