// This module implements the ExsciLexerLua class.



#include "Exsci/exscilexerlua.h"
...
// The ctor.
ExsciLexerLua::ExsciLexerLua(QObject *parent)
    : ExsciLexer(parent), fold_compact(true)
{
}


// The dtor.
ExsciLexerLua::~ExsciLexerLua()
{
}


// Returns the language name.
const char *ExsciLexerLua::language() const
{
    return "Lua";
}
...
const char *ExsciLexerLua::lexer() const
{
    return "lua";
}
...
// words.
QStringList ExsciLexerLua::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *ExsciLexerLua::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
int ExsciLexerLua::braceStyle() const
{
    return Operator;
}
...
QColor ExsciLexerLua::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool ExsciLexerLua::defaultEolFill(int style) const
{
...
QFont ExsciLexerLua::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerLua::keywords(int set) const
{
    if (set == 1)
        // Keywords.
        return
...
QString ExsciLexerLua::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerLua::defaultPaper(int style) const
{
    switch (style)
    {
    case Comment:
...
void ExsciLexerLua::refreshProperties()
{
    setCompactProp();
}
...
bool ExsciLexerLua::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerLua::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool ExsciLexerLua::foldCompact() const
{
    return fold_compact;
}
...
void ExsciLexerLua::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerLua::setCompactProp()
{
