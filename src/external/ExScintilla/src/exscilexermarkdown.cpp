// This module implements the ExsciLexerMarkdown class.



#include "Exsci/exscilexermarkdown.h"

#include <qfont.h>


// The ctor.
ExsciLexerMarkdown::ExsciLexerMarkdown(QObject *parent)
    : ExsciLexer(parent)
{
}
...
// The dtor.
ExsciLexerMarkdown::~ExsciLexerMarkdown()
{
}


// Returns the language name.
const char *ExsciLexerMarkdown::language() const
{
    return "Markdown";
}
...
const char *ExsciLexerMarkdown::lexer() const
{
    return "markdown";
}
...
QColor ExsciLexerMarkdown::defaultColor(int style) const
{
    switch (style)
    {
    case Special:
...
QFont ExsciLexerMarkdown::defaultFont(int style) const
{
    QFont f;
...
QColor ExsciLexerMarkdown::defaultPaper(int style) const
{
    switch (style)
    {
    case Prechar:
...
QString ExsciLexerMarkdown::description(int style) const
{
    switch (style)
    {
    case Default:
