// This module implements the ExsciLexer class.
...
void ExsciLexer::setEditor(ExsciScintilla *editor)
{
    attached_editor = editor;

    if (attached_editor)
    {
        attached_editor->SendScintilla(ExsciScintillaBase::SCI_SETSTYLEBITS,
                styleBitsNeeded());
    }
}
...
const char *ExsciLexer::lexer() const
{
    return 0;
}
...
int ExsciLexer::lexerId() const
{
    return ExsciScintillaBase::SCLEX_CONTAINER;
}


// Return the number of style bits needed by the lexer.
int ExsciLexer::styleBitsNeeded() const
{
    if (!attached_editor)
        return 5;

    return attached_editor->SendScintilla(ExsciScintillaBase::SCI_GETSTYLEBITSNEEDED);
}


// Make sure the style defaults have been set.
void ExsciLexer::setStyleDefaults() const
{
...
ExsciLexer::StyleData &ExsciLexer::styleData(int style) const
{
...
void ExsciLexer::setAPIs(ExsciAbstractAPIs *apis)
{
    apiSet = apis;
}
...
ExsciAbstractAPIs *ExsciLexer::apis() const
{
    return apiSet;
}
...
// auto-completion.
const char *ExsciLexer::autoCompletionFillups() const
{
    return "(";
}
...
int ExsciLexer::indentationGuideView() const
{
    return ExsciScintillaBase::SC_IV_LOOKBOTH;
}


// Default implementation to return the list of character sequences that can
// separate auto-completion words.
QStringList ExsciLexer::autoCompletionWordSeparators() const
{
    return QStringList();
}
...
// block.
const char *ExsciLexer::blockStartKeyword(int *) const
{
    return 0;
}
...
// block.
const char *ExsciLexer::blockStart(int *) const
{
    return 0;
}
...
// block.
const char *ExsciLexer::blockEnd(int *) const
{
    return 0;
}
...
int ExsciLexer::braceStyle() const
{
    return -1;
}
...
// auto-indenting.
int ExsciLexer::blockLookback() const
{
    return 20;
}
...
bool ExsciLexer::caseSensitive() const
{
    return true;
}
...
const char *ExsciLexer::wordCharacters() const
{
    return 0;
}
...
int ExsciLexer::defaultStyle() const
{
    return 0;
}
...
QColor ExsciLexer::color(int style) const
{
...
QColor ExsciLexer::paper(int style) const
{
...
QFont ExsciLexer::font(int style) const
{
...
bool ExsciLexer::eolFill(int style) const
{
...
const char *ExsciLexer::keywords(int) const
{
    return 0;
}
...
bool ExsciLexer::defaultEolFill(int) const
{
    return false;
}
...
QFont ExsciLexer::defaultFont(int) const
{
    return defaultFont();
}
...
QFont ExsciLexer::defaultFont() const
{
    return defFont;
}
...
void ExsciLexer::setDefaultFont(const QFont &f)
{
    defFont = f;
}
...
QColor ExsciLexer::defaultColor(int) const
{
    return defaultColor();
}
...
QColor ExsciLexer::defaultColor() const
{
    return defColor;
}
...
void ExsciLexer::setDefaultColor(const QColor &c)
{
    defColor = c;
}
...
QColor ExsciLexer::defaultPaper(int) const
{
    return defaultPaper();
}
...
QColor ExsciLexer::defaultPaper() const
{
    return defPaper;
}
...
void ExsciLexer::setDefaultPaper(const QColor &c)
{
    defPaper = c;
    ...
    setPaper(c, ExsciScintillaBase::STYLE_DEFAULT);
}


// Read properties from the settings.
bool ExsciLexer::readProperties(QSettings &,const QString &)
{
    return true;
}
...
void ExsciLexer::refreshProperties()
{
}


// Write properties to the settings.
bool ExsciLexer::writeProperties(QSettings &,const QString &) const
{
    return true;
}
...
bool ExsciLexer::readSettings(QSettings &qs,const char *prefix)
{
...
bool ExsciLexer::writeSettings(QSettings &qs,const char *prefix) const
{
    bool rc = true;
    QString key, fmt("%1");
    int num;
...
void ExsciLexer::setAutoIndentStyle(int autoindentstyle)
{
...
void ExsciLexer::setColor(const QColor &c, int style)
{
    if (style >= 0)
    {
...
void ExsciLexer::setEolFill(bool eolfill, int style)
{
    if (style >= 0)
    {
...
void ExsciLexer::setFont(const QFont &f, int style)
{
    if (style >= 0)
    {
...
void ExsciLexer::setPaper(const QColor &c, int style)
{
    if (style >= 0)
    {
    ...
    else
    {
        ...
        emit paperChanged(c, ExsciScintillaBase::STYLE_DEFAULT);
    }
}
