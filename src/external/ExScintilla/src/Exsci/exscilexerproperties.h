// This defines the interface to the ExsciLexerProperties class.



#ifndef EXSCILEXERPROPERTIES_H
#define EXSCILEXERPROPERTIES_H
...
//! \brief The ExsciLexerProperties class encapsulates the Scintilla
//! Properties lexer.
class EXSCINTILLA_EXPORT ExsciLexerProperties : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerProperties with parent \a parent.  \a parent is
    //! typically the ExsciScintilla instance.
    ExsciLexerProperties(QObject *parent = 0);

    //! Destroys the ExsciLexerProperties instance.
    virtual ~ExsciLexerProperties();
...
private:
    ...
    ExsciLexerProperties(const ExsciLexerProperties &);
    ExsciLexerProperties &operator=(const ExsciLexerProperties &);
};
