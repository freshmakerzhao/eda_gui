// This defines the interface to the ExsciLexerVHDL class.



#ifndef EXSCILEXERVHDL_H
#define EXSCILEXERVHDL_H
...
//! \brief The ExsciLexerVHDL class encapsulates the Scintilla VHDL lexer.
class EXSCINTILLA_EXPORT ExsciLexerVHDL : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerVHDL with parent \a parent.  \a parent is
    //! typically the ExsciScintilla instance.
    ExsciLexerVHDL(QObject *parent = 0);

    //! Destroys the ExsciLexerVHDL instance.
    virtual ~ExsciLexerVHDL();
...
private:
    ...
    ExsciLexerVHDL(const ExsciLexerVHDL &);
    ExsciLexerVHDL &operator=(const ExsciLexerVHDL &);
};
