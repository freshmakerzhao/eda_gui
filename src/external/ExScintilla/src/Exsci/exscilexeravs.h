// This defines the interface to the ExsciLexerAVS class.



#ifndef EXSCILEXERAVS_H
#define EXSCILEXERAVS_H
...
//! \brief The ExsciLexerAVS class encapsulates the Scintilla AVS lexer.
class EXSCINTILLA_EXPORT ExsciLexerAVS : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerAVS with parent \a parent.  \a parent is typically
    //! the ExsciScintilla instance.
    ExsciLexerAVS(QObject *parent = 0);

    //! Destroys the ExsciLexerAVS instance.
    virtual ~ExsciLexerAVS();
...
private:
    ...
    ExsciLexerAVS(const ExsciLexerAVS &);
    ExsciLexerAVS &operator=(const ExsciLexerAVS &);
};
