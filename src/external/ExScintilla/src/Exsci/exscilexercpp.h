// This defines the interface to the ExsciLexerCPP class.



#ifndef EXSCILEXERCPP_H
#define EXSCILEXERCPP_H
...
//! \brief The ExsciLexerCPP class encapsulates the Scintilla C++
//! lexer.
class EXSCINTILLA_EXPORT ExsciLexerCPP : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerCPP with parent \a parent.  \a parent is typically
    //! the ExsciScintilla instance.  \a caseInsensitiveKeywords is true if the
    //! lexer ignores the case of keywords.
    ExsciLexerCPP(QObject *parent = 0, bool caseInsensitiveKeywords = false);

    //! Destroys the ExsciLexerCPP instance.
    virtual ~ExsciLexerCPP();
...
private:
    ...
    ExsciLexerCPP(const ExsciLexerCPP &);
    ExsciLexerCPP &operator=(const ExsciLexerCPP &);
};
