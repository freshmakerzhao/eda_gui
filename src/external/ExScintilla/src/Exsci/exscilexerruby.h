// This defines the interface to the ExsciLexerRuby class.



#ifndef EXSCILEXERRUBY_H
#define EXSCILEXERRUBY_H
...
//! \brief The ExsciLexerRuby class encapsulates the Scintilla Ruby lexer.
class EXSCINTILLA_EXPORT ExsciLexerRuby : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerRuby with parent \a parent.  \a parent is
    //! typically the ExsciScintilla instance.
    ExsciLexerRuby(QObject *parent = 0);

    //! Destroys the ExsciLexerRuby instance.
    virtual ~ExsciLexerRuby();
...
private:
    ...
    ExsciLexerRuby(const ExsciLexerRuby &);
    ExsciLexerRuby &operator=(const ExsciLexerRuby &);
};
