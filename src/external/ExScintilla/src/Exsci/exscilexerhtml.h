// This defines the interface to the ExsciLexerHTML class.



#ifndef EXSCILEXERHTML_H
#define EXSCILEXERHTML_H
...
//! \brief The ExsciLexerHTML class encapsulates the Scintilla HTML lexer.
class EXSCINTILLA_EXPORT ExsciLexerHTML : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerHTML with parent \a parent.  \a parent is
    //! typically the ExsciScintilla instance.
    ExsciLexerHTML(QObject *parent = 0);

    //! Destroys the ExsciLexerHTML instance.
    virtual ~ExsciLexerHTML();
...
private:
    ...
    ExsciLexerHTML(const ExsciLexerHTML &);
    ExsciLexerHTML &operator=(const ExsciLexerHTML &);
};
