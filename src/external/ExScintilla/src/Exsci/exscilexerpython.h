// This defines the interface to the ExsciLexerPython class.



#ifndef EXSCILEXERPYTHON_H
#define EXSCILEXERPYTHON_H
...
//! \brief The ExsciLexerPython class encapsulates the Scintilla Python lexer.
class EXSCINTILLA_EXPORT ExsciLexerPython : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerPython with parent \a parent.  \a parent is
    //! typically the ExsciScintilla instance.
    ExsciLexerPython(QObject *parent = 0);

    //! Destroys the ExsciLexerPython instance.
    virtual ~ExsciLexerPython();
    ...
    ExsciLexerPython::IndentationWarning indentationWarning() const {return indent_warn;}
...
public slots:
    ...
    virtual void setIndentationWarning(ExsciLexerPython::IndentationWarning warn);
...
private:
    ...
    ExsciLexerPython(const ExsciLexerPython &);
    ExsciLexerPython &operator=(const ExsciLexerPython &);
};
