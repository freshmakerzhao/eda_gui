// This defines the interface to the ExsciLexerPOV class.



#ifndef EXSCILEXERPOV_H
#define EXSCILEXERPOV_H
...
//! \brief The ExsciLexerPOV class encapsulates the Scintilla POV lexer.
class EXSCINTILLA_EXPORT ExsciLexerPOV : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerPOV with parent \a parent.  \a parent is typically
    //! the ExsciScintilla instance.
    ExsciLexerPOV(QObject *parent = 0);

    //! Destroys the ExsciLexerPOV instance.
    virtual ~ExsciLexerPOV();
...
private:
    ...
    ExsciLexerPOV(const ExsciLexerPOV &);
    ExsciLexerPOV &operator=(const ExsciLexerPOV &);
};
