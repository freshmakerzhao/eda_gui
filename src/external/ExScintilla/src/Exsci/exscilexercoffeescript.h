// This defines the interface to the ExsciLexerCoffeeScript class.



#ifndef EXSCILEXERCOFFEESCRIPT_H
#define EXSCILEXERCOFFEESCRIPT_H
...
//! \brief The ExsciLexerCoffeeScript class encapsulates the Scintilla
//! CoffeeScript lexer.
class EXSCINTILLA_EXPORT ExsciLexerCoffeeScript : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerCoffeeScript with parent \a parent.  \a parent is
    //! typically the ExsciScintilla instance.
    ExsciLexerCoffeeScript(QObject *parent = 0);

    //! Destroys the ExsciLexerCoffeeScript instance.
    virtual ~ExsciLexerCoffeeScript();
...
private:
    ...
    ExsciLexerCoffeeScript(const ExsciLexerCoffeeScript &);
    ExsciLexerCoffeeScript &operator=(const ExsciLexerCoffeeScript &);
};
