// This defines the interface to the ExsciLexerVerilog class.



#ifndef EXSCILEXERVERILOG_H
#define EXSCILEXERVERILOG_H
...
//! \brief The ExsciLexerVerilog class encapsulates the Scintilla Verilog
//! lexer.
class EXSCINTILLA_EXPORT ExsciLexerVerilog : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerVerilog with parent \a parent.  \a parent is
    //! typically the ExsciScintilla instance.
    ExsciLexerVerilog(QObject *parent = 0);

    //! Destroys the ExsciLexerVerilog instance.
    virtual ~ExsciLexerVerilog();
...
private:
    ...
    ExsciLexerVerilog(const ExsciLexerVerilog &);
    ExsciLexerVerilog &operator=(const ExsciLexerVerilog &);
};
