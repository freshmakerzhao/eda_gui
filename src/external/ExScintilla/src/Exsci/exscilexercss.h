// This defines the interface to the ExsciLexerCSS class.



#ifndef EXSCILEXERCSS_H
#define EXSCILEXERCSS_H
...
//! \brief The ExsciLexerCSS class encapsulates the Scintilla CSS lexer.
class EXSCINTILLA_EXPORT ExsciLexerCSS : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerCSS with parent \a parent.  \a parent is typically
    //! the ExsciScintilla instance.
    ExsciLexerCSS(QObject *parent = 0);

    //! Destroys the ExsciLexerCSS instance.
    virtual ~ExsciLexerCSS();
...
private:
    ...
    ExsciLexerCSS(const ExsciLexerCSS &);
    ExsciLexerCSS &operator=(const ExsciLexerCSS &);
};
