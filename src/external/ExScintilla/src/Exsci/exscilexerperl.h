// This defines the interface to the ExsciLexerPerl class.



#ifndef EXSCILEXERPERL_H
#define EXSCILEXERPERL_H
...
//! \brief The ExsciLexerPerl class encapsulates the Scintilla Perl
//! lexer.
class EXSCINTILLA_EXPORT ExsciLexerPerl : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerPerl with parent \a parent.  \a parent is
    //! typically the ExsciScintilla instance.
    ExsciLexerPerl(QObject *parent = 0);

    //! Destroys the ExsciLexerPerl instance.
    virtual ~ExsciLexerPerl();
...
private:
    ...
    ExsciLexerPerl(const ExsciLexerPerl &);
    ExsciLexerPerl &operator=(const ExsciLexerPerl &);
};
