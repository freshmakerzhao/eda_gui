// This module defines interface to the ExsciStyle class.
...
//! \brief The ExsciStyle class encapsulates all the attributes of a style.
//!
...
class EXSCINTILLA_EXPORT ExsciStyle
{
public:
    ...
    //! Constructs a ExsciStyle instance for style number \a style.  If \a style
    //! is negative then a new style number is automatically allocated.
    ExsciStyle(int style = -1);
    ...
    //! respectively.
    ExsciStyle(int style, const QString &description, const QColor &color,
