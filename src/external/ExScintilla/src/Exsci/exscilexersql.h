// This defines the interface to the ExsciLexerSQL class.



#ifndef EXSCILEXERSQL_H
#define EXSCILEXERSQL_H
...
//! \brief The ExsciLexerSQL class encapsulates the Scintilla SQL lexer.
class EXSCINTILLA_EXPORT ExsciLexerSQL : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerSQL with parent \a parent.  \a parent is typically
    //! the ExsciScintilla instance.
    ExsciLexerSQL(QObject *parent = 0);

    //! Destroys the ExsciLexerSQL instance.
    virtual ~ExsciLexerSQL();
...
private:
    ...
    ExsciLexerSQL(const ExsciLexerSQL &);
    ExsciLexerSQL &operator=(const ExsciLexerSQL &);
};
