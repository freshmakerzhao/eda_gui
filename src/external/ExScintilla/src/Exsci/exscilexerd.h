// This defines the interface to the ExsciLexerD class.



#ifndef EXSCILEXERD_H
#define EXSCILEXERD_H
...
//! \brief The ExsciLexerD class encapsulates the Scintilla D lexer.
class EXSCINTILLA_EXPORT ExsciLexerD : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerD with parent \a parent.  \a parent is typically
    //! the ExsciScintilla instance.
    ExsciLexerD(QObject *parent = 0);

    //! Destroys the ExsciLexerD instance.
    virtual ~ExsciLexerD();
...
private:
    ...
    ExsciLexerD(const ExsciLexerD &);
    ExsciLexerD &operator=(const ExsciLexerD &);
};
