// This defines the interface to the ExsciLexerTCL class.



#ifndef EXSCILEXERTCL_H
#define EXSCILEXERTCL_H
...
//! \brief The ExsciLexerTCL class encapsulates the Scintilla TCL lexer.
class EXSCINTILLA_EXPORT ExsciLexerTCL : public ExsciLexer
{
	Q_OBJECT
...
public:
	...
	//! Construct a ExsciLexerTCL with parent \a parent.  \a parent is
    //! typically the ExsciScintilla instance.
	ExsciLexerTCL(QObject *parent = 0);

	//! Destroys the ExsciLexerTCL instance.
	virtual ~ExsciLexerTCL();
...
private:
	...
	ExsciLexerTCL(const ExsciLexerTCL &);
	ExsciLexerTCL &operator=(const ExsciLexerTCL &);
};
