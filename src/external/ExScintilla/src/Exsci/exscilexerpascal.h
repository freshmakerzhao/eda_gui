// This defines the interface to the ExsciLexerPascal class.



#ifndef EXSCILEXERPASCAL_H
#define EXSCILEXERPASCAL_H
...
//! \brief The ExsciLexerPascal class encapsulates the Scintilla Pascal lexer.
class EXSCINTILLA_EXPORT ExsciLexerPascal : public ExsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! Construct a ExsciLexerPascal with parent \a parent.  \a parent is
    //! typically the ExsciScintilla instance.
    ExsciLexerPascal(QObject *parent = 0);

    //! Destroys the ExsciLexerPascal instance.
    virtual ~ExsciLexerPascal();
...
private:
    ...
    ExsciLexerPascal(const ExsciLexerPascal &);
    ExsciLexerPascal &operator=(const ExsciLexerPascal &);
};
