// This module implements the ExsciLexerJSON class.



#include "Exsci/exscilexerjson.h"
...
// The ctor.
ExsciLexerJSON::ExsciLexerJSON(QObject *parent)
    : ExsciLexer(parent),
...
// The dtor.
ExsciLexerJSON::~ExsciLexerJSON()
{
}


// Returns the language name.
const char *ExsciLexerJSON::language() const
{
    return "JSON";
}
...
const char *ExsciLexerJSON::lexer() const
{
    return "json";
}
...
QColor ExsciLexerJSON::defaultColor(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
bool ExsciLexerJSON::defaultEolFill(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
QFont ExsciLexerJSON::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerJSON::keywords(int set) const
{
    if (set == 1)
...
QString ExsciLexerJSON::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerJSON::defaultPaper(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
void ExsciLexerJSON::refreshProperties()
{   
...
bool ExsciLexerJSON::readProperties(QSettings &qs,const QString &prefix)
{
...
bool ExsciLexerJSON::writeProperties(QSettings &qs,const QString &prefix) const
{
...
void ExsciLexerJSON::setHighlightComments(bool highlight)
{
...
void ExsciLexerJSON::setAllowCommentsProp()
{
...
void ExsciLexerJSON::setHighlightEscapeSequences(bool highlight)
{
...
void ExsciLexerJSON::setEscapeSequenceProp()
{
...
void ExsciLexerJSON::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerJSON::setCompactProp()
{
