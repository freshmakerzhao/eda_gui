// This module implements the ExsciLexerVHDL class.



#include "Exsci/exscilexervhdl.h"
...
// The ctor.
ExsciLexerVHDL::ExsciLexerVHDL(QObject *parent)
    : ExsciLexer(parent),
...
// The dtor.
ExsciLexerVHDL::~ExsciLexerVHDL()
{
}


// Returns the language name.
const char *ExsciLexerVHDL::language() const
{
    return "VHDL";
}
...
const char *ExsciLexerVHDL::lexer() const
{
    return "vhdl";
}
...
int ExsciLexerVHDL::braceStyle() const
{
    return Attribute;
}
...
QColor ExsciLexerVHDL::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool ExsciLexerVHDL::defaultEolFill(int style) const
{
...
QFont ExsciLexerVHDL::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerVHDL::keywords(int set) const
{
    if (set == 1)
        return
...
QString ExsciLexerVHDL::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerVHDL::defaultPaper(int style) const
{
    if (style == UnclosedString)
...
void ExsciLexerVHDL::refreshProperties()
{
    setCommentProp();
    setCompactProp();
    setAtElseProp();
...
bool ExsciLexerVHDL::readProperties(QSettings &qs,const QString &prefix)
{
...
bool ExsciLexerVHDL::writeProperties(QSettings &qs,const QString &prefix) const
{
...
bool ExsciLexerVHDL::foldComments() const
{
...
void ExsciLexerVHDL::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void ExsciLexerVHDL::setCommentProp()
{
...
bool ExsciLexerVHDL::foldCompact() const
{
    return fold_compact;
}
...
void ExsciLexerVHDL::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerVHDL::setCompactProp()
{
...
bool ExsciLexerVHDL::foldAtElse() const
{
    return fold_atelse;
}
...
void ExsciLexerVHDL::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void ExsciLexerVHDL::setAtElseProp()
{
...
bool ExsciLexerVHDL::foldAtBegin() const
{
    return fold_atbegin;
}
...
void ExsciLexerVHDL::setFoldAtBegin(bool fold)
{
    fold_atbegin = fold;
...
void ExsciLexerVHDL::setAtBeginProp()
{
...
bool ExsciLexerVHDL::foldAtParenthesis() const
{
...
void ExsciLexerVHDL::setFoldAtParenthesis(bool fold)
{
    fold_atparenth = fold;
...
void ExsciLexerVHDL::setAtParenthProp()
{
