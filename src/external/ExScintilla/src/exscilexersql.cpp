// This module implements the ExsciLexerSQL class.



#include "Exsci/exscilexersql.h"
...
// The ctor.
ExsciLexerSQL::ExsciLexerSQL(QObject *parent)
    : ExsciLexer(parent),
...
// The dtor.
ExsciLexerSQL::~ExsciLexerSQL()
{
}


// Returns the language name.
const char *ExsciLexerSQL::language() const
{
    return "SQL";
}
...
const char *ExsciLexerSQL::lexer() const
{
    return "sql";
}
...
int ExsciLexerSQL::braceStyle() const
{
    return Operator;
}
...
QColor ExsciLexerSQL::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool ExsciLexerSQL::defaultEolFill(int style) const
{
    if (style == PlusPrompt)
        return true;
...
QFont ExsciLexerSQL::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerSQL::keywords(int set) const
{
    if (set == 1)
        return
...
QString ExsciLexerSQL::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerSQL::defaultPaper(int style) const
{
    if (style == PlusPrompt)
...
void ExsciLexerSQL::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool ExsciLexerSQL::readProperties(QSettings &qs, const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerSQL::writeProperties(QSettings &qs, const QString &prefix) const
{
    int rc = true;
...
void ExsciLexerSQL::setFoldAtElse(bool fold)
{
    at_else = fold;
...
void ExsciLexerSQL::setAtElseProp()
{
...
void ExsciLexerSQL::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void ExsciLexerSQL::setCommentProp()
{
...
void ExsciLexerSQL::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerSQL::setCompactProp()
{
...
void ExsciLexerSQL::setFoldOnlyBegin(bool fold)
{
    only_begin = fold;
...
void ExsciLexerSQL::setOnlyBeginProp()
{
...
void ExsciLexerSQL::setQuotedIdentifiers(bool enable)
{
...
void ExsciLexerSQL::setBackticksIdentifierProp()
{
...
void ExsciLexerSQL::setHashComments(bool enable)
{
...
void ExsciLexerSQL::setNumbersignCommentProp()
{
...
void ExsciLexerSQL::setBackslashEscapes(bool enable)
{
...
void ExsciLexerSQL::setBackslashEscapesProp()
{
...
// Enable dotted words.
void ExsciLexerSQL::setDottedWords(bool enable)
{
...
void ExsciLexerSQL::setAllowDottedWordProp()
{
