// This module implements the ExsciLexerRuby class.



#include "Exsci/exscilexerruby.h"
...
// The ctor.
ExsciLexerRuby::ExsciLexerRuby(QObject *parent)
...
// The dtor.
ExsciLexerRuby::~ExsciLexerRuby()
{
}


// Returns the language name.
const char *ExsciLexerRuby::language() const
{
    return "Ruby";
}
...
const char *ExsciLexerRuby::lexer() const
{
    return "ruby";
}
...
const char *ExsciLexerRuby::blockStart(int *style) const
{
    if (style)
        *style = Keyword;
...
const char *ExsciLexerRuby::blockEnd(int *style) const
{
    if (style)
        *style = Keyword;
...
// Return the list of words that can start end a block.
const char *ExsciLexerRuby::blockStartKeyword(int *style) const
{
    if (style)
        *style = Keyword;
...
int ExsciLexerRuby::braceStyle() const
{
    return Operator;
}
...
QColor ExsciLexerRuby::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool ExsciLexerRuby::defaultEolFill(int style) const
{
    bool fill;
    ...
    default:
        fill = ExsciLexer::defaultEolFill(style);
    }
...
QFont ExsciLexerRuby::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerRuby::keywords(int set) const
{
    if (set == 1)
        return
...
QString ExsciLexerRuby::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerRuby::defaultPaper(int style) const
{
    switch (style)
    {
    case Error:
...
void ExsciLexerRuby::refreshProperties()
{
    setCommentProp();
    setCompactProp();
}
...
bool ExsciLexerRuby::readProperties(QSettings &qs, const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerRuby::writeProperties(QSettings &qs, const QString &prefix) const
{
    int rc = true;
...
void ExsciLexerRuby::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void ExsciLexerRuby::setCommentProp()
{
...
void ExsciLexerRuby::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerRuby::setCompactProp()
{
