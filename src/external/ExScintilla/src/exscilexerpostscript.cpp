// This module implements the ExsciLexerPostScript class.



#include "Exsci/exscilexerpostscript.h"
...
// The ctor.
ExsciLexerPostScript::ExsciLexerPostScript(QObject *parent)
    : ExsciLexer(parent),
...
// The dtor.
ExsciLexerPostScript::~ExsciLexerPostScript()
{
}


// Returns the language name.
const char *ExsciLexerPostScript::language() const
{
    return "PostScript";
}
...
const char *ExsciLexerPostScript::lexer() const
{
    return "ps";
}
...
int ExsciLexerPostScript::braceStyle() const
{
...
QColor ExsciLexerPostScript::defaultColor(int style) const
{
    switch (style)
    {
    case Comment:
...
QFont ExsciLexerPostScript::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerPostScript::keywords(int set) const
{
    if (set == 1)
        return
...
QString ExsciLexerPostScript::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerPostScript::defaultPaper(int style) const
{
...
void ExsciLexerPostScript::refreshProperties()
{
    setTokenizeProp();
    setLevelProp();
    setCompactProp();
...
bool ExsciLexerPostScript::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerPostScript::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool ExsciLexerPostScript::tokenize() const
{
    return ps_tokenize;
}
...
void ExsciLexerPostScript::setTokenize(bool tokenize)
{
...
void ExsciLexerPostScript::setTokenizeProp()
{
...
int ExsciLexerPostScript::level() const
{
    return ps_level;
}
...
void ExsciLexerPostScript::setLevel(int level)
{
    ps_level = level;
...
void ExsciLexerPostScript::setLevelProp()
{
...
bool ExsciLexerPostScript::foldCompact() const
{
    return fold_compact;
}
...
void ExsciLexerPostScript::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerPostScript::setCompactProp()
{
...
bool ExsciLexerPostScript::foldAtElse() const
{
    return fold_atelse;
}
...
void ExsciLexerPostScript::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void ExsciLexerPostScript::setAtElseProp()
{
