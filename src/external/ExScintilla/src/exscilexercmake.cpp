// This module implements the ExsciLexerCMake class.



#include "Exsci/exscilexercmake.h"
...
// The ctor.
ExsciLexerCMake::ExsciLexerCMake(QObject *parent)
    : ExsciLexer(parent), fold_atelse(false)
{
}


// The dtor.
ExsciLexerCMake::~ExsciLexerCMake()
{
}


// Returns the language name.
const char *ExsciLexerCMake::language() const
{
    return "CMake";
}
...
const char *ExsciLexerCMake::lexer() const
{
    return "cmake";
}
...
QColor ExsciLexerCMake::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
QFont ExsciLexerCMake::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerCMake::keywords(int set) const
{
    if (set == 1)
        return
...
QString ExsciLexerCMake::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerCMake::defaultPaper(int style) const
{
    switch (style)
    {
    case String:
...
void ExsciLexerCMake::refreshProperties()
{
    setAtElseProp();
}
...
bool ExsciLexerCMake::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerCMake::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool ExsciLexerCMake::foldAtElse() const
{
    return fold_atelse;
}
...
void ExsciLexerCMake::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void ExsciLexerCMake::setAtElseProp()
{
