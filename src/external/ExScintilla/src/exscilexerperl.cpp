// This module implements the ExsciLexerPerl class.



#include "Exsci/exscilexerperl.h"
...
// The ctor.
ExsciLexerPerl::ExsciLexerPerl(QObject *parent)
    : ExsciLexer(parent),
...
// The dtor.
ExsciLexerPerl::~ExsciLexerPerl()
{
}


// Returns the language name.
const char *ExsciLexerPerl::language() const
{
    return "Perl";
}
...
const char *ExsciLexerPerl::lexer() const
{
    return "perl";
}
...
// words.
QStringList ExsciLexerPerl::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *ExsciLexerPerl::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
const char *ExsciLexerPerl::blockEnd(int *style) const
{
    if (style)
        *style = Operator;
...
int ExsciLexerPerl::braceStyle() const
{
    return Operator;
}
...
const char *ExsciLexerPerl::wordCharacters() const
{
...
QColor ExsciLexerPerl::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool ExsciLexerPerl::defaultEolFill(int style) const
{
    switch (style)
    {
    case POD:
...
QFont ExsciLexerPerl::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerPerl::keywords(int set) const
{
    if (set == 1)
        return
...
QString ExsciLexerPerl::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerPerl::defaultPaper(int style) const
{
    switch (style)
    {
    case Error:
...
void ExsciLexerPerl::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool ExsciLexerPerl::readProperties(QSettings &qs,const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerPerl::writeProperties(QSettings &qs,const QString &prefix) const
{
    int rc = true;
...
bool ExsciLexerPerl::foldComments() const
{
...
void ExsciLexerPerl::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void ExsciLexerPerl::setCommentProp()
{
...
bool ExsciLexerPerl::foldCompact() const
{
    return fold_compact;
}
...
void ExsciLexerPerl::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void ExsciLexerPerl::setCompactProp()
{
...
bool ExsciLexerPerl::foldPackages() const
{
...
void ExsciLexerPerl::setFoldPackages(bool fold)
{
    fold_packages = fold;
...
void ExsciLexerPerl::setPackagesProp()
{
...
bool ExsciLexerPerl::foldPODBlocks() const
{
...
void ExsciLexerPerl::setFoldPODBlocks(bool fold)
{
...
void ExsciLexerPerl::setPODBlocksProp()
{
...
void ExsciLexerPerl::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void ExsciLexerPerl::setAtElseProp()
{
