// This module implements the ExsciLexerFortran class.



#include "Exsci/exscilexerfortran.h"
...
// The ctor.
ExsciLexerFortran::ExsciLexerFortran(QObject *parent)
    : ExsciLexerFortran77(parent)
{
}


// The dtor.
ExsciLexerFortran::~ExsciLexerFortran()
{
}


// Returns the language name.
const char *ExsciLexerFortran::language() const
{
    return "Fortran";
}
...
const char *ExsciLexerFortran::lexer() const
{
    return "fortran";
}
...
const char *ExsciLexerFortran::keywords(int set) const
{
    if (set == 2)
        return
    ...
    return ExsciLexerFortran77::keywords(set);
}
