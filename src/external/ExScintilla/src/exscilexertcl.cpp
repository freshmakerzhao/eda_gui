// This module implements the ExsciLexerTCL class.
...
// The ctor.
ExsciLexerTCL::ExsciLexerTCL(QObject *parent)
...
// The dtor.
ExsciLexerTCL::~ExsciLexerTCL()
{
}


// Returns the language name.
const char *ExsciLexerTCL::language() const
{
    return "TCL";
}
...
const char *ExsciLexerTCL::lexer() const
{
    return "tcl";
}
...
int ExsciLexerTCL::braceStyle() const
{
    return Operator;
}
...
QColor ExsciLexerTCL::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool ExsciLexerTCL::defaultEolFill(int style) const
{
    switch (style)
    {
    case QuotedString:
...
QFont ExsciLexerTCL::defaultFont(int style) const
{
    QFont f;
...
const char *ExsciLexerTCL::keywords(int set) const
{
    if (set == 1)
        return
...
QString ExsciLexerTCL::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor ExsciLexerTCL::defaultPaper(int style) const
{
    switch (style)
    {
    case Comment:
...
void ExsciLexerTCL::refreshProperties()
{
    setCommentProp();
}
...
bool ExsciLexerTCL::readProperties(QSettings &qs, const QString &prefix)
{
    int rc = true;
...
bool ExsciLexerTCL::writeProperties(QSettings &qs, const QString &prefix) const
{
    int rc = true;
...
void ExsciLexerTCL::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void ExsciLexerTCL::setCommentProp()
{
