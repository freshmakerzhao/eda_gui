// This module implements the ExsciLexerSpice class.



#include "Exsci/exscilexerspice.h"
...
// The ctor.
ExsciLexerSpice::ExsciLexerSpice(QObject *parent)
    : ExsciLexer(parent)
{
}
...
// The dtor.
ExsciLexerSpice::~ExsciLexerSpice()
{
}


// Returns the language name.
const char *ExsciLexerSpice::language() const
{
    return "Spice";
}
...
const char *ExsciLexerSpice::lexer() const
{
    return "spice";
}
...
int ExsciLexerSpice::braceStyle() const
{
    return Parameter;
}
...
const char *ExsciLexerSpice::keywords(int set) const
{
    if (set == 1)
        return
...
QColor ExsciLexerSpice::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
QFont ExsciLexerSpice::defaultFont(int style) const
{
    QFont f;
...
QString ExsciLexerSpice::description(int style) const
{
    switch (style)
    {
    case Default:
