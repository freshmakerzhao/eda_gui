#ifndef SITESSLICEL_H
#define SITESSLICEL_H
...
public:
    ...
    SitesSliceL(const QColor &color, int cur_width, int cur_height, int tile_index_x,int tile_index_y,std::string &cur_type, std::string &cur_name, int site_index);
